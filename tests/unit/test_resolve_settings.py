...
class TestResolveSettings(unittest.TestCase):
    def setUp(self):
        self.default_settings = Settings.Settings({
            ...
            "item_hints": [],
            "hint_dist_user": {},
            "misc_hints": ["altar", "ganondorf", "warp_songs_and_owls"],
            "text_shuffle": "none",
    ...
    def test_default_settings(self):
        ...
        for setting in self.default_settings.settings_dict:
            self.assertTrue(
                setting in test_settings.settings_dict,
            ...
            if setting == "seed":
                ...
                self.assertTrue(
                    self.default_settings.create_compressed_rom,
                ...
                self.assertFalse(
                    ...
                    == self.default_settings.settings_dict[setting],
                    f"Default for {setting} changed. Was"
                    f" {self.default_settings.settings_dict[setting]} "
                ...
                self.assertEqual(
                    ...
                    self.default_settings.__getattribute__(setting),
                )
