...
eventlocations = {
    ...
    'Ice Cavern Blue Fire': 'Blue Fire Drop',
    # MQ doesn't exist in vanilla
    'Gerudo Training Grounds MQ Blue Fire': 'Blue Fire Drop',
    'Ganons Castle Water Trial Blue Fire': 'Blue Fire Drop',
    'Gerudo Fortress Carpenter Rescue': 'Carpenter Rescue',
    'Bombchu Bowling Bombchus': 'More Bombchus',
    'Haunted Wasteland Bombchu Salesman': 'More Bombchus',
    'Windmill Drain Well': 'Drain Well',
    'Defeat Morpha': 'Lake Refill',
