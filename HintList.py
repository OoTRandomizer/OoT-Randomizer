...
hintTable = {
    ...
    'Forest Temple Boss Key Chest':                                ("a #turned trunk# contains", None, ['dungeon', 'sometimes']),
    ...
    'Bottom of the Well Freestanding Key':                         ("#inside a coffin# hides", None, ['dungeon', 'sometimes']),
    ...
    'Shadow Temple Freestanding Key':                              ("#inside a burning skull# lies", None, ['dungeon', 'sometimes']),
    ...
    'Ganons Castle Shadow Trial Golden Gauntlets Chest':           ("#light in the test of darkness# unveils", None, ['dungeon', 'sometimes']),
    ...
    'Water Temple Boss Key Chest':                                 ("dodging #rolling boulders under the lake# leads to", "dodging #rolling boulders in the Water Temple# leads to", 'exclude'),
