...
hintTable: dict[str, tuple[list[str] | str, Optional[str], str | list[str]]] = {
    ...
    # Tree Shuffle
    'HF Child Tree 1':                                               ('a #tree amid eastern Peahats in child# drops', 'a #child tree near the Kokiri Forest road# drops', 'exclude'),
    'HF Child Tree 2':                                               ('a #tree amid eastern Peahats in child# drops', 'a #child tree near the Kokiri Forest road# drops', 'exclude'),
    'HF Child Tree 3':                                               ('a #tree amid eastern Peahats in child# drops', 'a #child tree near the Kokiri Forest road# drops', 'exclude'),
    'HF Child Tree 4':                                               ('a #tree amid eastern Peahats in child# drops', 'a #child tree near the Kokiri Forest road# drops', 'exclude'),
    'HF Child Tree 5':                                               ('a #tree amid eastern Peahats in child# drops', 'a #child tree near the Kokiri Forest road# drops', 'exclude'),
    'HF Child Tree 6':                                               ('a #tree amid eastern Peahats in child# drops', 'a #child tree near the Kokiri Forest road# drops', 'exclude'),
    'HF Child Tree 7':                                               ('a #tree on the western plain in child# drops', 'a #child tree west of Lon Lon Ranch# drops', 'exclude'),
    'HF Child Tree 8':                                               ('a #tree beneath the castle road in child# drops', 'a #child tree near the Market approach# drops', 'exclude'),
    'HF Child Tree 9':                                               ('a #tree amid southern Peahats in child# drops', 'a #child tree northwest of the Kokiri Forest entrance# drops', 'exclude'),
    'HF Child Tree 10':                                              ('a #tree amid southern Peahats in child# drops', 'a #child tree northwest of the Kokiri Forest entrance# drops', 'exclude'),
    'HF Child Tree 11':                                              ('a #tree amid southern Peahats in child# drops', 'a #child tree northwest of the Kokiri Forest entrance# drops', 'exclude'),
    'HF Child Tree 12':                                              ('a #tree amid southern Peahats in child# drops', 'a #child tree northwest of the Kokiri Forest entrance# drops', 'exclude'),
    'HF Child Tree 13':                                              ('a #tree amid southern Peahats in child# drops', 'a #child tree northwest of the Kokiri Forest entrance# drops', 'exclude'),
    'HF Child Tree 14':                                              ('a #tree amid southern Peahats in child# drops', 'a #child tree northwest of the Kokiri Forest entrance# drops', 'exclude'),
    'HF Child Tree 15':                                              ("a #tree at the field's southeastern edge in child# drops", 'a #child tree beside the Kokiri Forest entrance# drops', 'exclude'),
    'HF Child Tree 16':                                              ("a #tree at the field's southeastern edge in child# drops", 'a #child tree beside the Kokiri Forest entrance# drops', 'exclude'),
    'HF Child Tree 17':                                              ("a #tree at the field's southeastern edge in child# drops", 'a #child tree beside the Kokiri Forest entrance# drops', 'exclude'),
    'HF Child Tree 18':                                              ("a #tree at the field's southeastern edge in child# drops", 'a #child tree beside the Kokiri Forest entrance# drops', 'exclude'),
    'HF Child Tree 19':                                              ("a #tree at the field's southeastern edge in child# drops", 'a #child tree beside the Kokiri Forest entrance# drops', 'exclude'),
    'HF Child Tree 20':                                              ("a #tree at the field's southeastern edge in child# drops", 'a #child tree beside the Kokiri Forest entrance# drops', 'exclude'),
    'HF Child Tree 21':                                              ('a #tree where the eastern roads divide in child# drops', "a #child tree between Zora's River and Kokiri Forest# drops", 'exclude'),
    'HF Child Tree 22':                                              ('a #tree where the eastern roads divide in child# drops', "a #child tree between Zora's River and Kokiri Forest# drops", 'exclude'),
    'HF Child Tree 23':                                              ('a #tree where the eastern roads divide in child# drops', "a #child tree between Zora's River and Kokiri Forest# drops", 'exclude'),
    'HF Child Tree 24':                                              ('a #tree where the eastern roads divide in child# drops', "a #child tree between Zora's River and Kokiri Forest# drops", 'exclude'),
    'HF Child Tree 25':                                              ('a #tree where the eastern roads divide in child# drops', "a #child tree between Zora's River and Kokiri Forest# drops", 'exclude'),
    'HF Child Tree 26':                                              ('a #tree where the eastern roads divide in child# drops', "a #child tree between Zora's River and Kokiri Forest# drops", 'exclude'),
    'HF Child Tree 27':                                              ('a #tree below the western cliffs in child# drops', 'a #child tree northwest of Lon Lon Ranch# drops', 'exclude'),
    'HF Child Tree 28':                                              ('a #tree below the western cliffs in child# drops', 'a #child tree northwest of Lon Lon Ranch# drops', 'exclude'),
    'HF Child Tree 29':                                              ('a #tree below the western cliffs in child# drops', 'a #child tree northwest of Lon Lon Ranch# drops', 'exclude'),
    'HF Child Tree 30':                                              ('a #tree below the western cliffs in child# drops', 'a #child tree northwest of Lon Lon Ranch# drops', 'exclude'),
    'HF Child Tree 31':                                              ('a #tree below the western cliffs in child# drops', 'a #child tree northwest of Lon Lon Ranch# drops', 'exclude'),
    'HF Child Tree 32':                                              ('a #tree below the western cliffs in child# drops', 'a #child tree northwest of Lon Lon Ranch# drops', 'exclude'),
    'HF Child Tree 33':                                              ('a #tree in the deepest southern grove in child# drops', 'a #child tree south of Lon Lon Ranch# drops', 'exclude'),
    'HF Child Tree 34':                                              ('a #tree in the deepest southern grove in child# drops', 'a #child tree south of Lon Lon Ranch# drops', 'exclude'),
    'HF Child Tree 35':                                              ('a #tree in the deepest southern grove in child# drops', 'a #child tree south of Lon Lon Ranch# drops', 'exclude'),
    'HF Child Tree 36':                                              ('a #tree in the deepest southern grove in child# drops', 'a #child tree south of Lon Lon Ranch# drops', 'exclude'),
    'HF Child Tree 37':                                              ('a #tree in the deepest southern grove in child# drops', 'a #child tree south of Lon Lon Ranch# drops', 'exclude'),
    'HF Child Tree 38':                                              ('a #tree in the deepest southern grove in child# drops', 'a #child tree south of Lon Lon Ranch# drops', 'exclude'),
    'HF Child Tree 39':                                              ('a #tree on the castle road in child# drops', 'a #child tree near the Market road# drops', 'exclude'),
    'HF Child Tree 40':                                              ('a #tree on the castle road in child# drops', 'a #child tree near the Market road# drops', 'exclude'),
    'HF Child Tree 41':                                              ('a #tree below the village trail in child# drops', 'a #child tree southwest of Kakariko Village# drops', 'exclude'),
    'HF Child Tree 42':                                              ('a #tree overlooking the ranch in child# drops', 'a #child tree east of Lon Lon Ranch# drops', 'exclude'),
    'HF Child Tree 43':                                              ("a #tree along the thieves' road in child# drops", 'a #child tree toward Gerudo Valley# drops', 'exclude'),
    'HF Child Tree 44':                                              ('a #tree above the lakeside road in child# drops', 'a #child tree near Lake Hylia# drops', 'exclude'),
    'HF Child Tree 45':                                              ('a #tree beside the ranch walls in child# drops', 'a #child tree near Lon Lon Ranch# drops', 'exclude'),
    'HF Child Tree 46':                                              ('a #tree on the open southern plain in child# drops', 'a #child tree between Lon Lon Ranch and Lake Hylia# drops', 'exclude'),
    'HF Child Tree 47':                                              ("a #tree beneath Death Mountain's road in child# drops", 'a #child tree near the Kakariko Village entrance# drops', 'exclude'),
    'HF Adult Tree 1':                                               ('a #tree amid southeastern Peahats in adult# drops', 'an #adult tree near the Kokiri Forest road# drops', 'exclude'),
    'HF Adult Tree 2':                                               ('a #tree amid southeastern Peahats in adult# drops', 'an #adult tree near the Kokiri Forest road# drops', 'exclude'),
    'HF Adult Tree 3':                                               ('a #tree amid southeastern Peahats in adult# drops', 'an #adult tree near the Kokiri Forest road# drops', 'exclude'),
    'HF Adult Tree 4':                                               ('a #tree amid southeastern Peahats in adult# drops', 'an #adult tree near the Kokiri Forest road# drops', 'exclude'),
    'HF Adult Tree 5':                                               ('a #tree amid southeastern Peahats in adult# drops', 'an #adult tree near the Kokiri Forest road# drops', 'exclude'),
    'HF Adult Tree 6':                                               ('a #tree amid southeastern Peahats in adult# drops', 'an #adult tree near the Kokiri Forest road# drops', 'exclude'),
    'HF Adult Tree 7':                                               ("a #tree at the field's southern edge in adult# drops", 'an #adult tree beside the Kokiri Forest entrance# drops', 'exclude'),
    'HF Adult Tree 8':                                               ("a #tree at the field's southern edge in adult# drops", 'an #adult tree beside the Kokiri Forest entrance# drops', 'exclude'),
    'HF Adult Tree 9':                                               ("a #tree at the field's southern edge in adult# drops", 'an #adult tree beside the Kokiri Forest entrance# drops', 'exclude'),
    'HF Adult Tree 10':                                              ("a #tree at the field's southern edge in adult# drops", 'an #adult tree beside the Kokiri Forest entrance# drops', 'exclude'),
    'HF Adult Tree 11':                                              ("a #tree at the field's southern edge in adult# drops", 'an #adult tree beside the Kokiri Forest entrance# drops', 'exclude'),
    'HF Adult Tree 12':                                              ("a #tree at the field's southern edge in adult# drops", 'an #adult tree beside the Kokiri Forest entrance# drops', 'exclude'),
    'HF Adult Tree 13':                                              ('a #tree where the eastern roads divide in adult# drops', "an #adult tree between Zora's River and Kokiri Forest# drops", 'exclude'),
    'HF Adult Tree 14':                                              ('a #tree where the eastern roads divide in adult# drops', "an #adult tree between Zora's River and Kokiri Forest# drops", 'exclude'),
    'HF Adult Tree 15':                                              ('a #tree where the eastern roads divide in adult# drops', "an #adult tree between Zora's River and Kokiri Forest# drops", 'exclude'),
    'HF Adult Tree 16':                                              ('a #tree where the eastern roads divide in adult# drops', "an #adult tree between Zora's River and Kokiri Forest# drops", 'exclude'),
    'HF Adult Tree 17':                                              ('a #tree where the eastern roads divide in adult# drops', "an #adult tree between Zora's River and Kokiri Forest# drops", 'exclude'),
    'HF Adult Tree 18':                                              ('a #tree where the eastern roads divide in adult# drops', "an #adult tree between Zora's River and Kokiri Forest# drops", 'exclude'),
    'HF Adult Tree 19':                                              ('a #tree in the southern Peahat grove in adult# drops', 'an #adult tree south of Lon Lon Ranch# drops', 'exclude'),
    'HF Adult Tree 20':                                              ('a #tree in the southern Peahat grove in adult# drops', 'an #adult tree south of Lon Lon Ranch# drops', 'exclude'),
    'HF Adult Tree 21':                                              ('a #tree in the southern Peahat grove in adult# drops', 'an #adult tree south of Lon Lon Ranch# drops', 'exclude'),
    'HF Adult Tree 22':                                              ('a #tree in the southern Peahat grove in adult# drops', 'an #adult tree south of Lon Lon Ranch# drops', 'exclude'),
    'HF Adult Tree 23':                                              ('a #tree in the southern Peahat grove in adult# drops', 'an #adult tree south of Lon Lon Ranch# drops', 'exclude'),
    'HF Adult Tree 24':                                              ('a #tree in the southern Peahat grove in adult# drops', 'an #adult tree south of Lon Lon Ranch# drops', 'exclude'),
    'HF Adult Tree 25':                                              ('a #tree below the western cliffs in adult# drops', 'an #adult tree northwest of Lon Lon Ranch# drops', 'exclude'),
    'HF Adult Tree 26':                                              ('a #tree below the western cliffs in adult# drops', 'an #adult tree northwest of Lon Lon Ranch# drops', 'exclude'),
    'HF Adult Tree 27':                                              ('a #tree below the western cliffs in adult# drops', 'an #adult tree northwest of Lon Lon Ranch# drops', 'exclude'),
    'HF Adult Tree 28':                                              ('a #tree below the western cliffs in adult# drops', 'an #adult tree northwest of Lon Lon Ranch# drops', 'exclude'),
    'HF Adult Tree 29':                                              ('a #tree below the western cliffs in adult# drops', 'an #adult tree northwest of Lon Lon Ranch# drops', 'exclude'),
    'HF Adult Tree 30':                                              ('a #tree below the western cliffs in adult# drops', 'an #adult tree northwest of Lon Lon Ranch# drops', 'exclude'),
    'HF Adult Tree 31':                                              ('a #tree on the western plain in adult# drops', 'an #adult tree west of Lon Lon Ranch# drops', 'exclude'),
    'HF Adult Tree 32':                                              ('a #tree on the castle road in adult# drops', 'an #adult tree near the Market road# drops', 'exclude'),
    'HF Adult Tree 33':                                              ('a #tree on the castle road in adult# drops', 'an #adult tree near the Market road# drops', 'exclude'),
    'HF Adult Tree 34':                                              ('a #tree below the village trail in adult# drops', 'an #adult tree southwest of Kakariko Village# drops', 'exclude'),
    'HF Adult Tree 35':                                              ('a #tree beneath the drawbridge road in adult# drops', 'an #adult tree near the Market approach# drops', 'exclude'),
    'HF Adult Tree 36':                                              ('a #tree beside the ranch walls in adult# drops', 'an #adult tree near Lon Lon Ranch# drops', 'exclude'),
    'HF Adult Tree 37':                                              ('a #tree on the open southern plain in adult# drops', 'an #adult tree between Lon Lon Ranch and Lake Hylia# drops', 'exclude'),
    'HF Adult Tree 38':                                              ('a #tree overlooking the ranch in adult# drops', 'an #adult tree east of Lon Lon Ranch# drops', 'exclude'),
    'HF Adult Tree 39':                                              ("a #tree beneath Death Mountain's road in adult# drops", 'an #adult tree near the Kakariko Village entrance# drops', 'exclude'),
    'HF Adult Tree 40':                                              ('a #tree above the lakeside road in adult# drops', 'an #adult tree near Lake Hylia# drops', 'exclude'),
    'HF Adult Tree 41':                                              ("a #tree along the thieves' road in adult# drops", 'an #adult tree toward Gerudo Valley# drops', 'exclude'),
    'Market Child Tree':                                             ("the #market's lone tree# drops", 'the #tree in the child Market# drops', 'exclude'),
    'HC Malon Tree':                                                 ('the #spider-haunted tree beside a ranch girl# drops', 'the #tree beside Malon outside Hyrule Castle# drops', 'exclude'),
    'HC Child Tree 1':                                               ('a #tree lining the royal approach# drops', 'a #tree along the lower Hyrule Castle path# drops', 'exclude'),
    'HC Child Tree 2':                                               ('a #tree lining the royal approach# drops', 'a #tree along the lower Hyrule Castle path# drops', 'exclude'),
    'HC Child Tree 3':                                               ('a #tree lining the royal approach# drops', 'a #tree along the lower Hyrule Castle path# drops', 'exclude'),
    'HC Child Tree 4':                                               ('a #tree lining the royal approach# drops', 'a #tree along the lower Hyrule Castle path# drops', 'exclude'),
    'HC Child Tree 5':                                               ('a #tree on the near side of the royal moat# drops', 'a #tree beside the lower Hyrule Castle moat# drops', 'exclude'),
    'HC Child Tree 6':                                               ('a #tree on the far side of the royal moat# drops', 'a #tree beside the upper Hyrule Castle moat# drops', 'exclude'),
    'HC Child Tree 7':                                               ('a #tree watching the castle gate# drops', 'a #tree near the Hyrule Castle grounds entrance# drops', 'exclude'),
    'HC Child Tree 8':                                               ('a #tree beyond the royal moat# drops', 'a #tree deep in the Hyrule Castle grounds# drops', 'exclude'),
    'LLR Child Tree':                                                ('the #spider-haunted ranch tree# drops', "the #tree beside Lon Lon Ranch's outer field# drops", 'exclude'),
    'Kak Child Tree':                                                ('the #spider-haunted village tree in child# drops', 'the #child tree in Kakariko Village# drops', 'exclude'),
    'Kak Adult Tree':                                                ('the #weathered village tree in adult# drops', 'the #adult tree in Kakariko Village# drops', 'exclude'),
    'ZR Child Tree':                                                 ('the #spider-haunted riverside tree# drops', "the #tree beside Zora's River# drops", 'exclude'),
    'ZF Child Tree':                                                 ('the #spider-haunted fountain tree# drops', "the #tree beside Zora's Fountain# drops", 'exclude'),
