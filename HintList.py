...
conditional_always: dict[str, Callable[[World], bool]] = {
    'Market Guard House 10 Big Poes':                  lambda world: world.settings.big_poe_count > 3 and 'big_poes' not in world.settings.misc_hints,
    ...
    'Kak House of Skulltula 30 Gold Skulltula Reward': lambda world: tokens_required_by_settings(world) < 30 and '30_skulltulas' not in world.settings.misc_hints,
    'Kak House of Skulltula 40 Gold Skulltula Reward': lambda world: tokens_required_by_settings(world) < 40 and '40_skulltulas' not in world.settings.misc_hints,
    'Kak House of Skulltula 50 Gold Skulltula Reward': lambda world: tokens_required_by_settings(world) < 50 and '50_skulltulas' not in world.settings.misc_hints,
    'ZR Frogs Ocarina Game':                           lambda world: 'frogs2' not in world.settings.misc_hints,
    'LH Fishing Hole Loach Reward':                    lambda world: world.settings.shuffle_loach_reward == 'vanilla',
}
...
conditional_sometimes: dict[str, Callable[[World], bool]] = {
    ...
    'HC Great Fairy Fountain Reward':           lambda world: world.settings.shuffle_interior_entrances == 'off',
    'OGC Great Fairy Fountain Reward':          lambda world: world.settings.shuffle_interior_entrances == 'off',
...
hintTable: dict[str, tuple[list[str] | str, Optional[str], str | list[str]]] = {
    ...
    'Market Guard House 10 Big Poes':                              ("#ghost hunters# will be rewarded with", "catching #Big Poes# leads to", ['overworld', 'sometimes']),
    ...
    'Kak House of Skulltula 50 Gold Skulltula Reward':             (["#50 bug badges# rewards", "#50 spider souls# yields", "#50 auriferous arachnids# lead to"], "slaying #50 Gold Skulltulas# reveals", ['overworld', 'sometimes']),
    'Kak House of Skulltula 40 Gold Skulltula Reward':             (["#40 bug badges# rewards", "#40 spider souls# yields", "#40 auriferous arachnids# lead to"], "slaying #40 Gold Skulltulas# reveals", ['overworld', 'sometimes']),
    'Kak House of Skulltula 30 Gold Skulltula Reward':             (["#30 bug badges# rewards", "#30 spider souls# yields", "#30 auriferous arachnids# lead to"], "slaying #30 Gold Skulltulas# reveals", ['overworld', 'sometimes']),
    'Kak House of Skulltula 20 Gold Skulltula Reward':             (["#20 bug badges# rewards", "#20 spider souls# yields", "#20 auriferous arachnids# lead to"], "slaying #20 Gold Skulltulas# reveals", ['overworld', 'sometimes']),
    ...
    'HC Storms Grotto GS':                                         ("a #spider behind a muddy wall# in a grotto holds", None, ['overworld', 'sometimes']),
    'HF Cow Grotto GS':                                            ("a #spider behind webs# in a grotto holds", None, ['overworld', 'sometimes']),
    ...
    'HC Great Fairy Fountain Reward':                              ("the #fairy of fire# holds", "a #fairy outside Hyrule Castle# holds", ['overworld', 'sometimes']),
    'OGC Great Fairy Fountain Reward':                             ("the #fairy of strength# holds", "a #fairy outside Ganon's Castle# holds", ['overworld', 'sometimes']),
    ...
    'KF Midos House Top Left Chest':                               ("the #leader of the Kokiri# hides", "#inside Mido's house# is", 'exclude'),
    'KF Midos House Top Right Chest':                              ("the #leader of the Kokiri# hides", "#inside Mido's house# is", 'exclude'),
    'KF Midos House Bottom Left Chest':                            ("the #leader of the Kokiri# hides", "#inside Mido's house# is", 'exclude'),
    'KF Midos House Bottom Right Chest':                           ("the #leader of the Kokiri# hides", "#inside Mido's house# is", 'exclude'),
    ...
    'Graveyard Dampes Grave Hookshot Chest':                       ("a chest hidden by a #speedy spectre# holds", "#dead Dampé's first prize# is", 'exclude'),
    ...
    'Temple of Time Light Arrow Cutscene':                         ("the #final gift of a princess# is", None, 'exclude'),
    ...
    'LH Fishing Hole Child Reward':                                ("#fishing in youth# bestows", None, 'exclude'),
    'LH Fishing Hole Adult Reward':                                ("#fishing in maturity# bestows", None, 'exclude'),
    ...
    'Kak House of Skulltula 10 Gold Skulltula Reward':             (["#10 bug badges# rewards", "#10 spider souls# yields", "#10 auriferous arachnids# lead to"], "slaying #10 Gold Skulltulas# reveals", 'exclude'),
    ...
    'LLR Talons House Chickens':                                   ("#finding Super Cuccos# is rewarded with", None, 'exclude'),
    ...
    'Graveyard Dampes Grave Freestanding PoH':                     ("#racing a ghost# leads to", "#dead Dampé's second# prize is", 'exclude'),
    'LLR Tower Freestanding PoH':                                  ("in a #ranch silo# lies", None, 'exclude'),
    ...
    'LH Lab GS Crate':                                             ("a spider deed underwater in a #lab crate# holds", None, 'exclude'),
    ...
    'Colossus Grotto Deku Scrub Front':                            ("a #scrub underground duo# sells", None, 'exclude'),
    'Colossus Grotto Deku Scrub Rear':                             ("a #scrub underground duo# sells", None, 'exclude'),
    ...
    'KF Shop':                                                  ("the #Kokiri Shop#", None, 'region'),
...
multiTable: dict[str, list[str]] = {
    ...
    'HF Valley Grotto':                                         ['HF Cow Grotto Cow', 'HF Cow Grotto GS'],
    ...
    'LH Lake Lab Pool':                                         ['LH Lab Dive', 'LH Lab GS Crate'],
    'LH Adult Bean Destination Checks':                         ['LH Freestanding PoH', 'LH Fishing Hole Adult Reward'],
    ...
    'Graveyard Dampe Race Rewards':                             ['Graveyard Dampes Grave Hookshot Chest', 'Graveyard Dampes Grave Freestanding PoH'],
    ...
    'Castle Fairy Checks':                                      ['HC Great Fairy Fountain Reward', 'OGC Great Fairy Fountain Reward'],
...
misc_location_hint_table: dict[str, dict[str, Any]] = {
    '10_skulltulas': {
        ...
        'item_location': 'Kak House of Skulltula 10 Gold Skulltula Reward',
    ...
    '20_skulltulas': {
        ...
        'item_location': 'Kak House of Skulltula 20 Gold Skulltula Reward',
    ...
    '30_skulltulas': {
        ...
        'item_location': 'Kak House of Skulltula 30 Gold Skulltula Reward',
    ...
    '40_skulltulas': {
        ...
        'item_location': 'Kak House of Skulltula 40 Gold Skulltula Reward',
    ...
    '50_skulltulas': {
        ...
        'item_location': 'Kak House of Skulltula 50 Gold Skulltula Reward',
