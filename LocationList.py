...
location_table = {
    ...
    "Field West Castle Town Grotto Chest":             ("Chest",       0x3E,  0x00, "Hyrule Field",           None,                     ("Grottos",)),
    "Remote Southern Grotto Chest":                    ("Chest",       0x3E,  0x02, "Hyrule Field",           None,                     ("Grottos",)),
    "Field Near Lake Outside Fence Grotto Chest":      ("Chest",       0x3E,  0x03, "Hyrule Field",           None,                     ("Grottos",)),
    "Kakariko Back Grotto Chest":                      ("Chest",       0x3E,  0x08, "Kakariko Village",       None,                     ("Kakariko", "Grottos")),
    "Zora River Plateau Open Grotto Chest":            ("Chest",       0x3E,  0x09, "Zora's River",           None,                     ("Grottos",)),
    "Kokiri Forest Storms Grotto Chest":               ("Chest",       0x3E,  0x0C, "Kokiri Forest",          None,                     ("Forest", "Grottos")),
    "Lost Woods Generic Grotto Chest":                 ("Chest",       0x3E,  0x14, "the Lost Woods",         None,                     ("Forest", "Grottos")),
    ...
    "Treasure Chest Game":                             ("Chest",       0x10,  0x0A, "the Market",             None,                     ("Castle Town", "Minigames")),

    "Zelda":                                           ("Cutscene",    0xFF,  0x01, "Temple of Time",         None,                     ("Castle Town",)),
    "Gift from Saria":                                 ("Cutscene",    0xFF,  0x02, "the Lost Woods",         None,                     ("Forest",)),
    "Zoras Fountain Fairy Reward":                     ("Cutscene",    0xFF,  0x10, "Zora's Fountain",        None,                     ("Fairies",)),
    "Hyrule Castle Fairy Reward":                      ("Cutscene",    0xFF,  0x11, "Hyrule Castle",          None,                     ("Castle Town", "Fairies")),
    "Desert Colossus Fairy Reward":                    ("Cutscene",    0xFF,  0x12, "Desert Colossus",        None,                     ("Fairies",)),
    ...
    "Ganons Castle Fairy Reward":                      ("Cutscene",    0xFF,  0x15, "outside Ganon's Castle", None,                     ("Castle Town", "Fairies")),

    "Sheik Forest Song":                               ("Song",        0xFF,  0x20, "Sacred Forest Meadow",   (0x20B0809, 0x20B0809),   ("Forest", "Songs")),
    "Sheik in Crater":                                 ("Song",        0xFF,  0x21, "Death Mountain Crater",  (0x224D7F1, 0x224D7F1),   ("Death Mountain", "Songs")),
    "Sheik in Ice Cavern":                             ("Song",        0xFF,  0x22, "Ice Cavern",             (0x2BEC889, 0x2BEC889),   ("Songs",)),
    "Sheik at Colossus":                               ("Song",        0xFF,  0x23, "Desert Colossus",        (0x218C57D, 0x218C57D),   ("Songs",)),
    "Sheik in Kakariko":                               ("Song",        0xFF,  0x24, "Kakariko Village",       (0x2000FE1, 0x2000FE1),   ("Kakariko", "Songs")),
    "Sheik at Temple":                                 ("Song",        0xFF,  0x25, "Temple of Time",         (0x2531329, 0x2531329),   ("Castle Town", "Songs")),
    "Impa at Castle":                                  ("Song",        0xFF,  0x26, "Hyrule Castle",          (0x2E8E925, 0x2E8E925),   ("Castle Town", "Songs")),
    "Song from Malon":                                 ("Song",        0xFF,  0x27, "Lon Lon Ranch",          (0x0D7EB53, 0x0D7EBCF),   ("Songs",)),
    "Song from Saria":                                 ("Song",        0xFF,  0x28, "Sacred Forest Meadow",   (0x20B1DB1, 0x20B1DB1),   ("Forest", "Songs")),
    "Song from Composer Grave":                        ("Song",        0xFF,  0x29, "the Graveyard",          (0x332A871, 0x332A871),   ("Kakariko", "Songs")),
    "Song from Ocarina of Time":                       ("Song",        0xFF,  0x2A, "Hyrule Field",           (0x252FC89, 0x252FC89),   ("Songs", "Need Spiritual Stones")),
    ...
    "Adult Fishing":                                   ("NPC",         0x49,  0x38, "Lake Hylia",             None,                     ("Minigames",)),
    ...
    "Bombchu Bowling Bomb Bag":                        ("NPC",         0x4B,  0x34, "the Market",             None,                     ("Castle Town", "Minigames")),
    "Bombchu Bowling Piece of Heart":                  ("NPC",         0x4B,  0x3E, "the Market",             None,                     ("Castle Town", "Minigames")),
    "Dog Lady":                                        ("NPC",         0x35,  0x3E, "the Market",             None,                     ("Castle Town",)),
    "Skull Kid":                                       ("NPC",         0x5B,  0x3E, "the Lost Woods",         None,                     ("Forest",)),
    "Ocarina Memory Game":                             ("NPC",         0x5B,  0x76, "the Lost Woods",         None,                     ("Forest", "Minigames")),
    "10 Gold Skulltula Reward":                        ("NPC",         0x50,  0x45, "Kakariko Village",       None,                     ("Kakariko", "Skulltula House")),
    "20 Gold Skulltula Reward":                        ("NPC",         0x50,  0x39, "Kakariko Village",       None,                     ("Kakariko", "Skulltula House")),
    "30 Gold Skulltula Reward":                        ("NPC",         0x50,  0x46, "Kakariko Village",       None,                     ("Kakariko", "Skulltula House")),
    "40 Gold Skulltula Reward":                        ("NPC",         0x50,  0x03, "Kakariko Village",       None,                     ("Kakariko", "Skulltula House")),
    "50 Gold Skulltula Reward":                        ("NPC",         0x50,  0x3E, "Kakariko Village",       None,                     ("Kakariko", "Skulltula House")),
    "Man on Roof":                                     ("NPC",         0x52,  0x3E, "Kakariko Village",       None,                     ("Kakariko",)),
    "Frog Ocarina Game":                               ("NPC",         0x54,  0x76, "Zora's River",           None,                     ()),
    "Frogs in the Rain":                               ("NPC",         0x54,  0x3E, "Zora's River",           None,                     ("Minigames",)),
    "Horseback Archery 1000 Points":                   ("NPC",         0x5D,  0x3E, "Gerudo's Fortress",      None,                     ("Gerudo", "Minigames")),
    "Horseback Archery 1500 Points":                   ("NPC",         0x5D,  0x30, "Gerudo's Fortress",      None,                     ("Gerudo", "Minigames")),
    "Child Shooting Gallery":                          ("NPC",         0x42,  0x60, "the Market",             None,                     ("Castle Town", "Minigames")),
    "Adult Shooting Gallery":                          ("NPC",         0x42,  0x30, "Kakariko Village",       None,                     ("Kakariko", "Minigames")),
    "Target in Woods":                                 ("NPC",         0x5B,  0x60, "the Lost Woods",         None,                     ("Forest",)),
    "Deku Theater Skull Mask":                         ("NPC",         0x3E,  0x77, "the Lost Woods",         None,                     ("Forest",)),
    "Deku Theater Mask of Truth":                      ("NPC",         0x3E,  0x7A, "the Lost Woods",         None,                     ("Forest", "Need Spiritual Stones")),
    "Anju as Adult":                                   ("NPC",         0x52,  0x1D, "Kakariko Village",       None,                     ("Kakariko",)),
    "Biggoron":                                        ("NPC",         0x60,  0x57, "Death Mountain Trail",   None,                     ("Death Mountain",)),
    "Anjus Chickens":                                  ("NPC",         0x52,  0x0F, "Kakariko Village",       None,                     ("Kakariko", "Minigames")),
    "Talons Chickens":                                 ("NPC",         0x4C,  0x14, "Lon Lon Ranch",          None,                     ("Kakariko", "Minigames")),
    ...
    "Gerudo Fortress Membership Card":                 ("NPC",         0x0C,  0x3A, "Gerudo's Fortress",      None,                     ("Gerudo",)),
    "Ocarina of Time":                                 ("NPC",         0x51,  0x0C, "Hyrule Field",           None,                     ("Need Spiritual Stones",)),

    "Impa House Freestanding PoH":                     ("Collectable", 0x37,  0x01, "Kakariko Village",       None,                     ("Kakariko",)),
    "Tektite Grotto Freestanding PoH":                 ("Collectable", 0x3E,  0x01, "Hyrule Field",           None,                     ("Grottos",)),
    "Windmill Freestanding PoH":                       ("Collectable", 0x48,  0x01, "Kakariko Village",       None,                     ("Kakariko",)),
    "Dampe Race Freestanding PoH":                     ("Collectable", 0x48,  0x07, "the Graveyard",          None,                     ("Kakariko", "Minigames")),
    "Lon Lon Tower Freestanding PoH":                  ("Collectable", 0x4C,  0x01, "Lon Lon Ranch",          None,                     ()),
    "Graveyard Freestanding PoH":                      ("Collectable", 0x53,  0x04, "the Graveyard",          None,                     ("Kakariko",)),
    "Gravedigging Tour":                               ("Collectable", 0x53,  0x08, "the Graveyard",          None,                     ("Kakariko",)),
    ...
    "Gerudo Valley Waterfall Freestanding PoH":        ("Collectable", 0x5A,  0x01, "Gerudo Valley",          None,                     ("Gerudo",)),
    "Gerudo Valley Crate Freestanding PoH":            ("Collectable", 0x5A,  0x02, "Gerudo Valley",          None,                     ("Gerudo",)),
    ...
    "Gerudo Fortress North F1 Carpenter":              ("Collectable", 0x0C,  0x0C, "Gerudo's Fortress",      None,                     ("Gerudo",)),
    "Gerudo Fortress North F2 Carpenter":              ("Collectable", 0x0C,  0x0A, "Gerudo's Fortress",      None,                     ("Gerudo",)),
    ...
    "Bottom of the Well Stick Pot":                    ("Event",       None,  None, "Bottom of the Well",     None,                     None),
    "Zoras Domain Stick Pot":                          ("Event",       None,  None, "Zora's Domain",          None,                     None),
    "Zoras Domain Nut Pot":                            ("Event",       None,  None, "Zora's Domain",          None,                     None),
    "Spirit Temple Nut Crate":                         ("Event",       None,  None, "Spirit Temple",          None,                     None),
    "Gerudo Fortress Carpenter Rescue":                ("Event",       None,  None, "Gerudo's Fortress",      None,                     None),
    "Haunted Wasteland Bombchu Salesman":              ("Event",       None,  None, "Haunted Wasteland",      None,                     None),
    "Ganons Castle Forest Trial Clear":                ("Event",       None,  None, "Ganon's Castle",         None,                     None),
    "Ganons Castle Fire Trial Clear":                  ("Event",       None,  None, "Ganon's Castle",         None,                     None),
    "Ganons Castle Water Trial Clear":                 ("Event",       None,  None, "Ganon's Castle",         None,                     None),
    "Ganons Castle Shadow Trial Clear":                ("Event",       None,  None, "Ganon's Castle",         None,                     None),
    "Ganons Castle Spirit Trial Clear":                ("Event",       None,  None, "Ganon's Castle",         None,                     None),
    "Ganons Castle Light Trial Clear":                 ("Event",       None,  None, "Ganon's Castle",         None,                     None),
    ...
    "Kokiri Shop Item 1":                              ("Shop",        0x2D,  0x30, "Kokiri Forest",          (shop_address(0, 0), None), ("Forest", "Shops")),
    "Kokiri Shop Item 2":                              ("Shop",        0x2D,  0x31, "Kokiri Forest",          (shop_address(0, 1), None), ("Forest", "Shops")),
    "Kokiri Shop Item 3":                              ("Shop",        0x2D,  0x32, "Kokiri Forest",          (shop_address(0, 2), None), ("Forest", "Shops")),
    "Kokiri Shop Item 4":                              ("Shop",        0x2D,  0x33, "Kokiri Forest",          (shop_address(0, 3), None), ("Forest", "Shops")),
    "Kokiri Shop Item 5":                              ("Shop",        0x2D,  0x34, "Kokiri Forest",          (shop_address(0, 4), None), ("Forest", "Shops")),
    "Kokiri Shop Item 6":                              ("Shop",        0x2D,  0x35, "Kokiri Forest",          (shop_address(0, 5), None), ("Forest", "Shops")),
    "Kokiri Shop Item 7":                              ("Shop",        0x2D,  0x36, "Kokiri Forest",          (shop_address(0, 6), None), ("Forest", "Shops")),
    "Kokiri Shop Item 8":                              ("Shop",        0x2D,  0x37, "Kokiri Forest",          (shop_address(0, 7), None), ("Forest", "Shops")),
    "Kakariko Potion Shop Item 1":                     ("Shop",        0x30,  0x30, "Kakariko Village",       (shop_address(1, 0), None), ("Kakariko", "Shops")),
    "Kakariko Potion Shop Item 2":                     ("Shop",        0x30,  0x31, "Kakariko Village",       (shop_address(1, 1), None), ("Kakariko", "Shops")),
    "Kakariko Potion Shop Item 3":                     ("Shop",        0x30,  0x32, "Kakariko Village",       (shop_address(1, 2), None), ("Kakariko", "Shops")),
    "Kakariko Potion Shop Item 4":                     ("Shop",        0x30,  0x33, "Kakariko Village",       (shop_address(1, 3), None), ("Kakariko", "Shops")),
    "Kakariko Potion Shop Item 5":                     ("Shop",        0x30,  0x34, "Kakariko Village",       (shop_address(1, 4), None), ("Kakariko", "Shops")),
    "Kakariko Potion Shop Item 6":                     ("Shop",        0x30,  0x35, "Kakariko Village",       (shop_address(1, 5), None), ("Kakariko", "Shops")),
    "Kakariko Potion Shop Item 7":                     ("Shop",        0x30,  0x36, "Kakariko Village",       (shop_address(1, 6), None), ("Kakariko", "Shops")),
    "Kakariko Potion Shop Item 8":                     ("Shop",        0x30,  0x37, "Kakariko Village",       (shop_address(1, 7), None), ("Kakariko", "Shops")),
    "Bombchu Shop Item 1":                             ("Shop",        0x32,  0x30, "the Market",             (shop_address(2, 0), None), ("Castle Town", "Shops")),
    "Bombchu Shop Item 2":                             ("Shop",        0x32,  0x31, "the Market",             (shop_address(2, 1), None), ("Castle Town", "Shops")),
    "Bombchu Shop Item 3":                             ("Shop",        0x32,  0x32, "the Market",             (shop_address(2, 2), None), ("Castle Town", "Shops")),
    "Bombchu Shop Item 4":                             ("Shop",        0x32,  0x33, "the Market",             (shop_address(2, 3), None), ("Castle Town", "Shops")),
    "Bombchu Shop Item 5":                             ("Shop",        0x32,  0x34, "the Market",             (shop_address(2, 4), None), ("Castle Town", "Shops")),
    "Bombchu Shop Item 6":                             ("Shop",        0x32,  0x35, "the Market",             (shop_address(2, 5), None), ("Castle Town", "Shops")),
    "Bombchu Shop Item 7":                             ("Shop",        0x32,  0x36, "the Market",             (shop_address(2, 6), None), ("Castle Town", "Shops")),
    "Bombchu Shop Item 8":                             ("Shop",        0x32,  0x37, "the Market",             (shop_address(2, 7), None), ("Castle Town", "Shops")),
    "Castle Town Potion Shop Item 1":                  ("Shop",        0x31,  0x30, "the Market",             (shop_address(3, 0), None), ("Castle Town", "Shops")),
    "Castle Town Potion Shop Item 2":                  ("Shop",        0x31,  0x31, "the Market",             (shop_address(3, 1), None), ("Castle Town", "Shops")),
    "Castle Town Potion Shop Item 3":                  ("Shop",        0x31,  0x32, "the Market",             (shop_address(3, 2), None), ("Castle Town", "Shops")),
    "Castle Town Potion Shop Item 4":                  ("Shop",        0x31,  0x33, "the Market",             (shop_address(3, 3), None), ("Castle Town", "Shops")),
    "Castle Town Potion Shop Item 5":                  ("Shop",        0x31,  0x34, "the Market",             (shop_address(3, 4), None), ("Castle Town", "Shops")),
    "Castle Town Potion Shop Item 6":                  ("Shop",        0x31,  0x35, "the Market",             (shop_address(3, 5), None), ("Castle Town", "Shops")),
    "Castle Town Potion Shop Item 7":                  ("Shop",        0x31,  0x36, "the Market",             (shop_address(3, 6), None), ("Castle Town", "Shops")),
    "Castle Town Potion Shop Item 8":                  ("Shop",        0x31,  0x37, "the Market",             (shop_address(3, 7), None), ("Castle Town", "Shops")),
    "Castle Town Bazaar Item 1":                       ("Shop",        0x2C,  0x30, "the Market",             (shop_address(4, 0), None), ("Castle Town", "Shops")),
    "Castle Town Bazaar Item 2":                       ("Shop",        0x2C,  0x31, "the Market",             (shop_address(4, 1), None), ("Castle Town", "Shops")),
    "Castle Town Bazaar Item 3":                       ("Shop",        0x2C,  0x32, "the Market",             (shop_address(4, 2), None), ("Castle Town", "Shops")),
    "Castle Town Bazaar Item 4":                       ("Shop",        0x2C,  0x33, "the Market",             (shop_address(4, 3), None), ("Castle Town", "Shops")),
    "Castle Town Bazaar Item 5":                       ("Shop",        0x2C,  0x34, "the Market",             (shop_address(4, 4), None), ("Castle Town", "Shops")),
    "Castle Town Bazaar Item 6":                       ("Shop",        0x2C,  0x35, "the Market",             (shop_address(4, 5), None), ("Castle Town", "Shops")),
    "Castle Town Bazaar Item 7":                       ("Shop",        0x2C,  0x36, "the Market",             (shop_address(4, 6), None), ("Castle Town", "Shops")),
    "Castle Town Bazaar Item 8":                       ("Shop",        0x2C,  0x37, "the Market",             (shop_address(4, 7), None), ("Castle Town", "Shops")),
    "Kakariko Bazaar Item 1":                          ("Shop",        0x2C,  0x38, "Kakariko Village",       (shop_address(5, 0), None), ("Kakariko", "Shops")),
    "Kakariko Bazaar Item 2":                          ("Shop",        0x2C,  0x39, "Kakariko Village",       (shop_address(5, 1), None), ("Kakariko", "Shops")),
    "Kakariko Bazaar Item 3":                          ("Shop",        0x2C,  0x3A, "Kakariko Village",       (shop_address(5, 2), None), ("Kakariko", "Shops")),
    "Kakariko Bazaar Item 4":                          ("Shop",        0x2C,  0x3B, "Kakariko Village",       (shop_address(5, 3), None), ("Kakariko", "Shops")),
    "Kakariko Bazaar Item 5":                          ("Shop",        0x2C,  0x3D, "Kakariko Village",       (shop_address(5, 4), None), ("Kakariko", "Shops")),
    "Kakariko Bazaar Item 6":                          ("Shop",        0x2C,  0x3E, "Kakariko Village",       (shop_address(5, 5), None), ("Kakariko", "Shops")),
    "Kakariko Bazaar Item 7":                          ("Shop",        0x2C,  0x3F, "Kakariko Village",       (shop_address(5, 6), None), ("Kakariko", "Shops")),
    "Kakariko Bazaar Item 8":                          ("Shop",        0x2C,  0x40, "Kakariko Village",       (shop_address(5, 7), None), ("Kakariko", "Shops")),
    ...
    "DC Deku Scrub Deku Nuts":                         ("NPC",         0x01,  0x30, "Dodongo's Cavern",       None,                     ("Deku Scrub",)),
    "DC Deku Scrub Deku Sticks":                       ("NPC",         0x01,  0x31, "Dodongo's Cavern",       None,                     ("Deku Scrub",)),
    "DC Deku Scrub Deku Seeds":                        ("NPC",         0x01,  0x33, "Dodongo's Cavern",       None,                     ("Deku Scrub",)),
    "DC Deku Scrub Deku Shield":                       ("NPC",         0x01,  0x34, "Dodongo's Cavern",       None,                     ("Deku Scrub",)),
    "Jabu Deku Scrub Deku Nuts":                       ("NPC",         0x02,  0x30, "Jabu Jabu's Belly",      None,                     ("Deku Scrub",)),
    "GC Deku Scrub Bombs":                             ("NPC",         0x0D,  0x37, "Ganon's Castle",         None,                     ("Deku Scrub",)),
    "GC Deku Scrub Arrows":                            ("NPC",         0x0D,  0x33, "Ganon's Castle",         None,                     ("Deku Scrub",)),
    "GC Deku Scrub Red Potion":                        ("NPC",         0x0D,  0x39, "Ganon's Castle",         None,                     ("Deku Scrub",)),
    "GC Deku Scrub Green Potion":                      ("NPC",         0x0D,  0x3A, "Ganon's Castle",         None,                     ("Deku Scrub",)),
    "DT MQ Deku Scrub Deku Shield":                    ("NPC",         0x00,  0x34, "Deku Tree",              None,                     ("Deku Scrub",)),
    "DC MQ Deku Scrub Deku Sticks":                    ("NPC",         0x01,  0x31, "Dodongo's Cavern",       None,                     ("Deku Scrub",)),
    "DC MQ Deku Scrub Deku Seeds":                     ("NPC",         0x01,  0x33, "Dodongo's Cavern",       None,                     ("Deku Scrub",)),
    "DC MQ Deku Scrub Deku Shield":                    ("NPC",         0x01,  0x34, "Dodongo's Cavern",       None,                     ("Deku Scrub",)),
    "DC MQ Deku Scrub Red Potion":                     ("NPC",         0x01,  0x39, "Dodongo's Cavern",       None,                     ("Deku Scrub",)),
    "GC MQ Deku Scrub Deku Nuts":                      ("NPC",         0x0D,  0x30, "Ganon's Castle",         None,                     ("Deku Scrub",)),
    "GC MQ Deku Scrub Bombs":                          ("NPC",         0x0D,  0x37, "Ganon's Castle",         None,                     ("Deku Scrub",)),
    "GC MQ Deku Scrub Arrows":                         ("NPC",         0x0D,  0x33, "Ganon's Castle",         None,                     ("Deku Scrub",)),
    "GC MQ Deku Scrub Red Potion":                     ("NPC",         0x0D,  0x39, "Ganon's Castle",         None,                     ("Deku Scrub",)),
    "GC MQ Deku Scrub Green Potion":                   ("NPC",         0x0D,  0x3A, "Ganon's Castle",         None,                     ("Deku Scrub",)),
    "HF Grotto Deku Scrub Piece of Heart":             ("GrottoNPC",   0x01,  0x3E, "Hyrule Field",           None,                     ("Deku Scrub", "Deku Scrub Upgrades", "Grottos")),
    "ZR Grotto Deku Scrub Red Potion":                 ("GrottoNPC",   0x02,  0x39, "Zora's River",           None,                     ("Deku Scrub", "Grottos")),
    "ZR Grotto Deku Scrub Green Potion":               ("GrottoNPC",   0x02,  0x3A, "Zora's River",           None,                     ("Deku Scrub", "Grottos")),
    "SFM Grotto Deku Scrub Red Potion":                ("GrottoNPC",   0x03,  0x39, "Sacred Forest Meadow",   None,                     ("Forest", "Deku Scrub", "Grottos")),
    "SFM Grotto Deku Scrub Green Potion":              ("GrottoNPC",   0x03,  0x3A, "Sacred Forest Meadow",   None,                     ("Forest", "Deku Scrub", "Grottos")),
    "LH Grotto Deku Scrub Deku Nuts":                  ("GrottoNPC",   0x04,  0x30, "Lake Hylia",             None,                     ("Deku Scrub", "Grottos")),
    "LH Grotto Deku Scrub Bombs":                      ("GrottoNPC",   0x04,  0x37, "Lake Hylia",             None,                     ("Deku Scrub", "Grottos")),
    "LH Grotto Deku Scrub Arrows":                     ("GrottoNPC",   0x04,  0x33, "Lake Hylia",             None,                     ("Deku Scrub", "Grottos")),
    "Valley Grotto Deku Scrub Red Potion":             ("GrottoNPC",   0x05,  0x39, "Gerudo Valley",          None,                     ("Gerudo", "Deku Scrub", "Grottos")),
    "Valley Grotto Deku Scrub Green Potion":           ("GrottoNPC",   0x05,  0x3A, "Gerudo Valley",          None,                     ("Gerudo", "Deku Scrub", "Grottos")),
    "LW Deku Scrub Deku Nuts":                         ("NPC",         0x5B,  0x30, "the Lost Woods",         None,                     ("Forest", "Deku Scrub")),
    "LW Deku Scrub Deku Sticks":                       ("NPC",         0x5B,  0x31, "the Lost Woods",         None,                     ("Forest", "Deku Scrub")),
    "LW Deku Scrub Deku Stick Upgrade":                ("NPC",         0x5B,  0x77, "the Lost Woods",         None,                     ("Forest", "Deku Scrub", "Deku Scrub Upgrades")),
    "LW Grotto Deku Scrub Arrows":                     ("GrottoNPC",   0x06,  0x33, "the Lost Woods",         None,                     ("Forest", "Deku Scrub", "Grottos")),
    "LW Grotto Deku Scrub Deku Nut Upgrade":           ("GrottoNPC",   0x06,  0x79, "the Lost Woods",         None,                     ("Forest", "Deku Scrub", "Deku Scrub Upgrades", "Grottos")),
    "Desert Grotto Deku Scrub Red Potion":             ("GrottoNPC",   0x07,  0x39, "Desert Colossus",        None,                     ("Deku Scrub", "Grottos")),
    "Desert Grotto Deku Scrub Green Potion":           ("GrottoNPC",   0x07,  0x3A, "Desert Colossus",        None,                     ("Deku Scrub", "Grottos")),
    "DMC Deku Scrub Bombs":                            ("NPC",         0x61,  0x37, "Death Mountain Crater",  None,                     ("Death Mountain", "Deku Scrub")),
    "DMC Grotto Deku Scrub Deku Nuts":                 ("GrottoNPC",   0x08,  0x30, "Death Mountain Crater",  None,                     ("Death Mountain", "Deku Scrub", "Grottos")),
    "DMC Grotto Deku Scrub Bombs":                     ("GrottoNPC",   0x08,  0x37, "Death Mountain Crater",  None,                     ("Death Mountain", "Deku Scrub", "Grottos")),
    "DMC Grotto Deku Scrub Arrows":                    ("GrottoNPC",   0x08,  0x33, "Death Mountain Crater",  None,                     ("Death Mountain", "Deku Scrub", "Grottos")),
    "Goron Grotto Deku Scrub Deku Nuts":               ("GrottoNPC",   0x09,  0x30, "Goron City",             None,                     ("Deku Scrub", "Grottos")),
    "Goron Grotto Deku Scrub Bombs":                   ("GrottoNPC",   0x09,  0x37, "Goron City",             None,                     ("Deku Scrub", "Grottos")),
    "Goron Grotto Deku Scrub Arrows":                  ("GrottoNPC",   0x09,  0x33, "Goron City",             None,                     ("Deku Scrub", "Grottos")),
    "LLR Grotto Deku Scrub Deku Nuts":                 ("GrottoNPC",   0x0A,  0x30, "Lon Lon Ranch",          None,                     ("Deku Scrub", "Grottos")),
    ...
    "Graveyard Gossip Stone":                          ("GossipStone", None,  None, None,                     None,                     None),
    "Hyrule Castle Malon Gossip Stone":                ("GossipStone", None,  None, None,                     None,                     None),
    "Hyrule Castle Rock Wall Gossip Stone":            ("GossipStone", None,  None, None,                     None,                     None),
    "Castle Storms Grotto Gossip Stone":               ("GossipStone", None,  None, None,                     None,                     None),
    "Field Valley Grotto Gossip Stone":                ("GossipStone", None,  None, None,                     None,                     None),
    "Deku Tree Gossip Stone (Left)":                   ("GossipStone", None,  None, None,                     None,                     None),
    "Deku Tree Gossip Stone (Right)":                  ("GossipStone", None,  None, None,                     None,                     None),
    "Kokiri Forest Gossip Stone":                      ("GossipStone", None,  None, None,                     None,                     None),
    "Lake Hylia Lab Gossip Stone":                     ("GossipStone", None,  None, None,                     None,                     None),
    "Lake Hylia Gossip Stone (Southeast)":             ("GossipStone", None,  None, None,                     None,                     None),
    "Lake Hylia Gossip Stone (Southwest)":             ("GossipStone", None,  None, None,                     None,                     None),
    "Lost Woods Gossip Stone":                         ("GossipStone", None,  None, None,                     None,                     None),
    "Sacred Forest Meadow Maze Gossip Stone (Lower)":  ("GossipStone", None,  None, None,                     None,                     None),
    "Sacred Forest Meadow Maze Gossip Stone (Upper)":  ("GossipStone", None,  None, None,                     None,                     None),
    "Sacred Forest Meadow Saria Gossip Stone":         ("GossipStone", None,  None, None,                     None,                     None),
    "Temple of Time Gossip Stone (Left)":              ("GossipStone", None,  None, None,                     None,                     None),
    "Temple of Time Gossip Stone (Left-Center)":       ("GossipStone", None,  None, None,                     None,                     None),
    "Temple of Time Gossip Stone (Right)":             ("GossipStone", None,  None, None,                     None,                     None),
    "Temple of Time Gossip Stone (Right-Center)":      ("GossipStone", None,  None, None,                     None,                     None),
    "Zoras Domain Gossip Stone":                       ("GossipStone", None,  None, None,                     None,                     None),
    "Zoras Fountain Fairy Gossip Stone":               ("GossipStone", None,  None, None,                     None,                     None),
