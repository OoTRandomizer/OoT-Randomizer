...
location_table = OrderedDict([
    ...
    ("KF GS Know It All House",                                      ("GS Token",     0x0C,  0x02, None,                        'Golden Skull Token',                    ("Kokiri Forest", "Skulltulas",))),
    ("KF GS Bean Patch",                                             ("GS Token",     0x0C,  0x01, None,                        'Golden Skull Token',                    ("Kokiri Forest", "Skulltulas",))),
    ("KF GS House of Twins",                                         ("GS Token",     0x0C,  0x04, None,                        'Golden Skull Token',                    ("Kokiri Forest", "Skulltulas",))),
    ...
    ("LW GS Bean Patch Near Bridge",                                 ("GS Token",     0x0D,  0x01, None,                        'Golden Skull Token',                    ("the Lost Woods", "Skulltulas",))),
    ("LW GS Bean Patch Near Theater",                                ("GS Token",     0x0D,  0x02, None,                        'Golden Skull Token',                    ("the Lost Woods", "Skulltulas",))),
    ("LW GS Above Theater",                                          ("GS Token",     0x0D,  0x04, None,                        'Golden Skull Token',                    ("the Lost Woods", "Skulltulas",))),
    ...
    ("SFM GS",                                                       ("GS Token",     0x0D,  0x08, None,                        'Golden Skull Token',                    ("Sacred Forest Meadow", "Skulltulas",))),
    ...
    ("HF GS Cow Grotto",                                             ("GS Token",     0x0A,  0x01, None,                        'Golden Skull Token',                    ("Hyrule Field", "Skulltulas", "Grottos"))),
    ("HF GS Near Kak Grotto",                                        ("GS Token",     0x0A,  0x02, None,                        'Golden Skull Token',                    ("Hyrule Field", "Skulltulas", "Grottos"))),
    ...
    ("Market GS Guard House",                                        ("GS Token",     0x0E,  0x08, None,                        'Golden Skull Token',                    ("the Market", "Skulltulas",))),
    ...
    ("HC GS Tree",                                                   ("GS Token",     0x0E,  0x04, None,                        'Golden Skull Token',                    ("Hyrule Castle", "Skulltulas",))),
    ("HC GS Storms Grotto",                                          ("GS Token",     0x0E,  0x02, None,                        'Golden Skull Token',                    ("Hyrule Castle", "Skulltulas", "Grottos"))),
    ...
    ("LLR GS House Window",                                          ("GS Token",     0x0B,  0x04, None,                        'Golden Skull Token',                    ("Lon Lon Ranch", "Skulltulas",))),
    ("LLR GS Tree",                                                  ("GS Token",     0x0B,  0x08, None,                        'Golden Skull Token',                    ("Lon Lon Ranch", "Skulltulas",))),
    ("LLR GS Rain Shed",                                             ("GS Token",     0x0B,  0x02, None,                        'Golden Skull Token',                    ("Lon Lon Ranch", "Skulltulas",))),
    ("LLR GS Back Wall",                                             ("GS Token",     0x0B,  0x01, None,                        'Golden Skull Token',                    ("Lon Lon Ranch", "Skulltulas",))),
    ...
    ("Kak GS Tree",                                                  ("GS Token",     0x10,  0x20, None,                        'Golden Skull Token',                    ("Kakariko Village", "Skulltulas",))),
    ("Kak GS Near Gate Guard",                                       ("GS Token",     0x10,  0x02, None,                        'Golden Skull Token',                    ("Kakariko Village", "Skulltulas",))),
    ("Kak GS Watchtower",                                            ("GS Token",     0x10,  0x04, None,                        'Golden Skull Token',                    ("Kakariko Village", "Skulltulas",))),
    ("Kak GS Skulltula House",                                       ("GS Token",     0x10,  0x10, None,                        'Golden Skull Token',                    ("Kakariko Village", "Skulltulas",))),
    ("Kak GS House Under Construction",                              ("GS Token",     0x10,  0x08, None,                        'Golden Skull Token',                    ("Kakariko Village", "Skulltulas",))),
    ("Kak GS Above Impas House",                                     ("GS Token",     0x10,  0x40, None,                        'Golden Skull Token',                    ("Kakariko Village", "Skulltulas",))),
    ...
    ("Graveyard GS Bean Patch",                                      ("GS Token",     0x10,  0x01, None,                        'Golden Skull Token',                    ("the Graveyard", "Skulltulas",))),
    ("Graveyard GS Wall",                                            ("GS Token",     0x10,  0x80, None,                        'Golden Skull Token',                    ("the Graveyard", "Skulltulas",))),
    ...
    ("DMT GS Near Kak",                                              ("GS Token",     0x0F,  0x04, None,                        'Golden Skull Token',                    ("Death Mountain Trail", "Skulltulas",))),
    ("DMT GS Bean Patch",                                            ("GS Token",     0x0F,  0x02, None,                        'Golden Skull Token',                    ("Death Mountain Trail", "Skulltulas",))),
    ("DMT GS Above Dodongos Cavern",                                 ("GS Token",     0x0F,  0x08, None,                        'Golden Skull Token',                    ("Death Mountain Trail", "Skulltulas",))),
    ("DMT GS Falling Rocks Path",                                    ("GS Token",     0x0F,  0x10, None,                        'Golden Skull Token',                    ("Death Mountain Trail", "Skulltulas",))),
    ...
    ("GC GS Center Platform",                                        ("GS Token",     0x0F,  0x20, None,                        'Golden Skull Token',                    ("Goron City", "Skulltulas",))),
    ("GC GS Boulder Maze",                                           ("GS Token",     0x0F,  0x40, None,                        'Golden Skull Token',                    ("Goron City", "Skulltulas",))),
    ...
    ("DMC GS Crate",                                                 ("GS Token",     0x0F,  0x80, None,                        'Golden Skull Token',                    ("Death Mountain Crater", "Skulltulas",))),
    ("DMC GS Bean Patch",                                            ("GS Token",     0x0F,  0x01, None,                        'Golden Skull Token',                    ("Death Mountain Crater", "Skulltulas",))),
    ...
    ("ZR GS Tree",                                                   ("GS Token",     0x11,  0x02, None,                        'Golden Skull Token',                    ("Zora's River", "Skulltulas",))),
    ("ZR GS Ladder",                                                 ("GS Token",     0x11,  0x01, None,                        'Golden Skull Token',                    ("Zora's River", "Skulltulas",))),
    ("ZR GS Near Raised Grottos",                                    ("GS Token",     0x11,  0x10, None,                        'Golden Skull Token',                    ("Zora's River", "Skulltulas",))),
    ("ZR GS Above Bridge",                                           ("GS Token",     0x11,  0x08, None,                        'Golden Skull Token',                    ("Zora's River", "Skulltulas",))),
    ...
    ("ZD GS Frozen Waterfall",                                       ("GS Token",     0x11,  0x40, None,                        'Golden Skull Token',                    ("Zora's Domain", "Skulltulas",))),
    ...
    ("ZF GS Above the Log",                                          ("GS Token",     0x11,  0x04, None,                        'Golden Skull Token',                    ("Zora's Fountain", "Skulltulas",))),
    ("ZF GS Tree",                                                   ("GS Token",     0x11,  0x80, None,                        'Golden Skull Token',                    ("Zora's Fountain", "Skulltulas",))),
    ("ZF GS Hidden Cave",                                            ("GS Token",     0x11,  0x20, None,                        'Golden Skull Token',                    ("Zora's Fountain", "Skulltulas",))),
    ...
    ("LH GS Bean Patch",                                             ("GS Token",     0x12,  0x01, None,                        'Golden Skull Token',                    ("Lake Hylia", "Skulltulas",))),
    ("LH GS Lab Wall",                                               ("GS Token",     0x12,  0x04, None,                        'Golden Skull Token',                    ("Lake Hylia", "Skulltulas",))),
    ("LH GS Small Island",                                           ("GS Token",     0x12,  0x02, None,                        'Golden Skull Token',                    ("Lake Hylia", "Skulltulas",))),
    ("LH GS Lab Crate",                                              ("GS Token",     0x12,  0x08, None,                        'Golden Skull Token',                    ("Lake Hylia", "Skulltulas",))),
    ("LH GS Tree",                                                   ("GS Token",     0x12,  0x10, None,                        'Golden Skull Token',                    ("Lake Hylia", "Skulltulas",))),
    ...
    ("GV GS Small Bridge",                                           ("GS Token",     0x13,  0x02, None,                        'Golden Skull Token',                    ("Gerudo Valley", "Skulltulas",))),
    ("GV GS Bean Patch",                                             ("GS Token",     0x13,  0x01, None,                        'Golden Skull Token',                    ("Gerudo Valley", "Skulltulas",))),
    ("GV GS Behind Tent",                                            ("GS Token",     0x13,  0x08, None,                        'Golden Skull Token',                    ("Gerudo Valley", "Skulltulas",))),
    ("GV GS Pillar",                                                 ("GS Token",     0x13,  0x04, None,                        'Golden Skull Token',                    ("Gerudo Valley", "Skulltulas",))),
    ...
    ("GF GS Top Floor",                                              ("GS Token",     0x14,  0x02, None,                        'Golden Skull Token',                    ("Gerudo's Fortress", "Skulltulas",))),
    ("GF GS Archery Range",                                          ("GS Token",     0x14,  0x01, None,                        'Golden Skull Token',                    ("Gerudo's Fortress", "Skulltulas",))),
    ...
    ("Wasteland GS",                                                 ("GS Token",     0x15,  0x02, None,                        'Golden Skull Token',                    ("Haunted Wasteland", "Skulltulas",))),
    ...
    ("Colossus GS Bean Patch",                                       ("GS Token",     0x15,  0x01, None,                        'Golden Skull Token',                    ("Desert Colossus", "Skulltulas",))),
    ("Colossus GS Tree",                                             ("GS Token",     0x15,  0x08, None,                        'Golden Skull Token',                    ("Desert Colossus", "Skulltulas",))),
    ("Colossus GS Hill",                                             ("GS Token",     0x15,  0x04, None,                        'Golden Skull Token',                    ("Desert Colossus", "Skulltulas",))),

    # Outside Ganon's Castle
    ("OGC Great Fairy Reward",                                       ("Cutscene",     0xFF,  0x15, None,                        'Double Defense',                        ("Outside Ganon's Castle", "Market", "Fairies"))),
    ("OGC GS",                                                       ("GS Token",     0x0E,  0x01, None,                        'Golden Skull Token',                    ("Outside Ganon's Castle", "Skulltulas",))),
    ...
    ("Deku Tree GS Compass Room",                                    ("GS Token",     0x00,  0x08, None,                        'Golden Skull Token',                    ("Deku Tree", "Vanilla", "Skulltulas",))),
    ("Deku Tree GS Basement Vines",                                  ("GS Token",     0x00,  0x04, None,                        'Golden Skull Token',                    ("Deku Tree", "Vanilla", "Skulltulas",))),
    ("Deku Tree GS Basement Gate",                                   ("GS Token",     0x00,  0x02, None,                        'Golden Skull Token',                    ("Deku Tree", "Vanilla", "Skulltulas",))),
    ("Deku Tree GS Basement Back Room",                              ("GS Token",     0x00,  0x01, None,                        'Golden Skull Token',                    ("Deku Tree", "Vanilla", "Skulltulas",))),
    # Deku Tree MQ
    ...
    ("Deku Tree MQ GS Lobby",                                        ("GS Token",     0x00,  0x02, None,                        'Golden Skull Token',                    ("Deku Tree", "Master Quest", "Skulltulas",))),
    ("Deku Tree MQ GS Compass Room",                                 ("GS Token",     0x00,  0x08, None,                        'Golden Skull Token',                    ("Deku Tree", "Master Quest", "Skulltulas",))),
    ("Deku Tree MQ GS Basement Graves Room",                         ("GS Token",     0x00,  0x04, None,                        'Golden Skull Token',                    ("Deku Tree", "Master Quest", "Skulltulas",))),
    ("Deku Tree MQ GS Basement Back Room",                           ("GS Token",     0x00,  0x01, None,                        'Golden Skull Token',                    ("Deku Tree", "Master Quest", "Skulltulas",))),
    # Deku Tree shared
    ...
    ("Dodongos Cavern GS Side Room Near Lower Lizalfos",             ("GS Token",     0x01,  0x10, None,                        'Golden Skull Token',                    ("Dodongo's Cavern", "Vanilla", "Skulltulas",))),
    ("Dodongos Cavern GS Scarecrow",                                 ("GS Token",     0x01,  0x02, None,                        'Golden Skull Token',                    ("Dodongo's Cavern", "Vanilla", "Skulltulas",))),
    ("Dodongos Cavern GS Alcove Above Stairs",                       ("GS Token",     0x01,  0x04, None,                        'Golden Skull Token',                    ("Dodongo's Cavern", "Vanilla", "Skulltulas",))),
    ("Dodongos Cavern GS Vines Above Stairs",                        ("GS Token",     0x01,  0x01, None,                        'Golden Skull Token',                    ("Dodongo's Cavern", "Vanilla", "Skulltulas",))),
    ("Dodongos Cavern GS Back Room",                                 ("GS Token",     0x01,  0x08, None,                        'Golden Skull Token',                    ("Dodongo's Cavern", "Vanilla", "Skulltulas",))),
    # Dodongo's Cavern MQ
    ...
    ("Dodongos Cavern MQ GS Scrub Room",                             ("GS Token",     0x01,  0x02, None,                        'Golden Skull Token',                    ("Dodongo's Cavern", "Master Quest", "Skulltulas",))),
    ("Dodongos Cavern MQ GS Larvae Room",                            ("GS Token",     0x01,  0x10, None,                        'Golden Skull Token',                    ("Dodongo's Cavern", "Master Quest", "Skulltulas",))),
    ("Dodongos Cavern MQ GS Lizalfos Room",                          ("GS Token",     0x01,  0x04, None,                        'Golden Skull Token',                    ("Dodongo's Cavern", "Master Quest", "Skulltulas",))),
    ("Dodongos Cavern MQ GS Song of Time Block Room",                ("GS Token",     0x01,  0x08, None,                        'Golden Skull Token',                    ("Dodongo's Cavern", "Master Quest", "Skulltulas",))),
    ("Dodongos Cavern MQ GS Back Area",                              ("GS Token",     0x01,  0x01, None,                        'Golden Skull Token',                    ("Dodongo's Cavern", "Master Quest", "Skulltulas",))),
    ...
    ("Jabu Jabus Belly GS Water Switch Room",                        ("GS Token",     0x02,  0x08, None,                        'Golden Skull Token',                    ("Jabu Jabu's Belly", "Vanilla", "Skulltulas",))),
    ("Jabu Jabus Belly GS Lobby Basement Lower",                     ("GS Token",     0x02,  0x01, None,                        'Golden Skull Token',                    ("Jabu Jabu's Belly", "Vanilla", "Skulltulas",))),
    ("Jabu Jabus Belly GS Lobby Basement Upper",                     ("GS Token",     0x02,  0x02, None,                        'Golden Skull Token',                    ("Jabu Jabu's Belly", "Vanilla", "Skulltulas",))),
    ("Jabu Jabus Belly GS Near Boss",                                ("GS Token",     0x02,  0x04, None,                        'Golden Skull Token',                    ("Jabu Jabu's Belly", "Vanilla", "Skulltulas",))),
    ...
    ("Jabu Jabus Belly MQ GS Boomerang Chest Room",                  ("GS Token",     0x02,  0x01, None,                        'Golden Skull Token',                    ("Jabu Jabu's Belly", "Master Quest", "Skulltulas",))),
    ("Jabu Jabus Belly MQ GS Tailpasaran Room",                      ("GS Token",     0x02,  0x04, None,                        'Golden Skull Token',                    ("Jabu Jabu's Belly", "Master Quest", "Skulltulas",))),
    ("Jabu Jabus Belly MQ GS Invisible Enemies Room",                ("GS Token",     0x02,  0x08, None,                        'Golden Skull Token',                    ("Jabu Jabu's Belly", "Master Quest", "Skulltulas",))),
    ("Jabu Jabus Belly MQ GS Near Boss",                             ("GS Token",     0x02,  0x02, None,                        'Golden Skull Token',                    ("Jabu Jabu's Belly", "Master Quest", "Skulltulas",))),
    ...
    ("Bottom of the Well GS West Inner Room",                        ("GS Token",     0x08,  0x04, None,                        'Golden Skull Token',                    ("Bottom of the Well", "Vanilla", "Skulltulas",))),
    ("Bottom of the Well GS East Inner Room",                        ("GS Token",     0x08,  0x02, None,                        'Golden Skull Token',                    ("Bottom of the Well", "Vanilla", "Skulltulas",))),
    ("Bottom of the Well GS Like Like Cage",                         ("GS Token",     0x08,  0x01, None,                        'Golden Skull Token',                    ("Bottom of the Well", "Vanilla", "Skulltulas",))),
    ...
    ("Bottom of the Well MQ GS Coffin Room",                         ("GS Token",     0x08,  0x04, None,                        'Golden Skull Token',                    ("Bottom of the Well", "Master Quest", "Skulltulas",))),
    ("Bottom of the Well MQ GS West Inner Room",                     ("GS Token",     0x08,  0x02, None,                        'Golden Skull Token',                    ("Bottom of the Well", "Master Quest", "Skulltulas",))),
    ("Bottom of the Well MQ GS Basement",                            ("GS Token",     0x08,  0x01, None,                        'Golden Skull Token',                    ("Bottom of the Well", "Master Quest", "Skulltulas",))),
    ...
    ("Forest Temple GS First Room",                                  ("GS Token",     0x03,  0x02, None,                        'Golden Skull Token',                    ("Forest Temple", "Vanilla", "Skulltulas",))),
    ("Forest Temple GS Lobby",                                       ("GS Token",     0x03,  0x08, None,                        'Golden Skull Token',                    ("Forest Temple", "Vanilla", "Skulltulas",))),
    ("Forest Temple GS Raised Island Courtyard",                     ("GS Token",     0x03,  0x01, None,                        'Golden Skull Token',                    ("Forest Temple", "Vanilla", "Skulltulas",))),
    ("Forest Temple GS Level Island Courtyard",                      ("GS Token",     0x03,  0x04, None,                        'Golden Skull Token',                    ("Forest Temple", "Vanilla", "Skulltulas",))),
    ("Forest Temple GS Basement",                                    ("GS Token",     0x03,  0x10, None,                        'Golden Skull Token',                    ("Forest Temple", "Vanilla", "Skulltulas",))),
    # Forest Temple MQ
    ...
    ("Forest Temple MQ GS First Hallway",                            ("GS Token",     0x03,  0x02, None,                        'Golden Skull Token',                    ("Forest Temple", "Master Quest", "Skulltulas",))),
    ("Forest Temple MQ GS Raised Island Courtyard",                  ("GS Token",     0x03,  0x01, None,                        'Golden Skull Token',                    ("Forest Temple", "Master Quest", "Skulltulas",))),
    ("Forest Temple MQ GS Level Island Courtyard",                   ("GS Token",     0x03,  0x04, None,                        'Golden Skull Token',                    ("Forest Temple", "Master Quest", "Skulltulas",))),
    ("Forest Temple MQ GS Well",                                     ("GS Token",     0x03,  0x08, None,                        'Golden Skull Token',                    ("Forest Temple", "Master Quest", "Skulltulas",))),
    ("Forest Temple MQ GS Block Push Room",                          ("GS Token",     0x03,  0x10, None,                        'Golden Skull Token',                    ("Forest Temple", "Master Quest", "Skulltulas",))),
    ...
    ("Fire Temple GS Boss Key Loop",                                 ("GS Token",     0x04,  0x02, None,                        'Golden Skull Token',                    ("Fire Temple", "Vanilla", "Skulltulas",))),
    ("Fire Temple GS Song of Time Room",                             ("GS Token",     0x04,  0x01, None,                        'Golden Skull Token',                    ("Fire Temple", "Vanilla", "Skulltulas",))),
    ("Fire Temple GS Boulder Maze",                                  ("GS Token",     0x04,  0x04, None,                        'Golden Skull Token',                    ("Fire Temple", "Vanilla", "Skulltulas",))),
    ("Fire Temple GS Scarecrow Climb",                               ("GS Token",     0x04,  0x10, None,                        'Golden Skull Token',                    ("Fire Temple", "Vanilla", "Skulltulas",))),
    ("Fire Temple GS Scarecrow Top",                                 ("GS Token",     0x04,  0x08, None,                        'Golden Skull Token',                    ("Fire Temple", "Vanilla", "Skulltulas",))),
    # Fire Temple MQ
    ...
    ("Fire Temple MQ GS Big Lava Room Open Door",                    ("GS Token",     0x04,  0x01, None,                        'Golden Skull Token',                    ("Fire Temple", "Master Quest", "Skulltulas",))),
    ("Fire Temple MQ GS Skull On Fire",                              ("GS Token",     0x04,  0x04, None,                        'Golden Skull Token',                    ("Fire Temple", "Master Quest", "Skulltulas",))),
    ("Fire Temple MQ GS Fire Wall Maze Center",                      ("GS Token",     0x04,  0x08, None,                        'Golden Skull Token',                    ("Fire Temple", "Master Quest", "Skulltulas",))),
    ("Fire Temple MQ GS Fire Wall Maze Side Room",                   ("GS Token",     0x04,  0x10, None,                        'Golden Skull Token',                    ("Fire Temple", "Master Quest", "Skulltulas",))),
    ("Fire Temple MQ GS Above Fire Wall Maze",                       ("GS Token",     0x04,  0x02, None,                        'Golden Skull Token',                    ("Fire Temple", "Master Quest", "Skulltulas",))),
    # Fire Temple shared
    ...
    ("Water Temple GS Behind Gate",                                  ("GS Token",     0x05,  0x01, None,                        'Golden Skull Token',                    ("Water Temple", "Vanilla", "Skulltulas",))),
    ("Water Temple GS Near Boss Key Chest",                          ("GS Token",     0x05,  0x08, None,                        'Golden Skull Token',                    ("Water Temple", "Vanilla", "Skulltulas",))),
    ("Water Temple GS Central Pillar",                               ("GS Token",     0x05,  0x04, None,                        'Golden Skull Token',                    ("Water Temple", "Vanilla", "Skulltulas",))),
    ("Water Temple GS Falling Platform Room",                        ("GS Token",     0x05,  0x02, None,                        'Golden Skull Token',                    ("Water Temple", "Vanilla", "Skulltulas",))),
    ("Water Temple GS River",                                        ("GS Token",     0x05,  0x10, None,                        'Golden Skull Token',                    ("Water Temple", "Vanilla", "Skulltulas",))),
    # Water Temple MQ
    ...
    ("Water Temple MQ GS Lizalfos Hallway",                          ("GS Token",     0x05,  0x01, None,                        'Golden Skull Token',                    ("Water Temple", "Master Quest", "Skulltulas",))),
    ("Water Temple MQ GS Before Upper Water Switch",                 ("GS Token",     0x05,  0x04, None,                        'Golden Skull Token',                    ("Water Temple", "Master Quest", "Skulltulas",))),
    ("Water Temple MQ GS River",                                     ("GS Token",     0x05,  0x02, None,                        'Golden Skull Token',                    ("Water Temple", "Master Quest", "Skulltulas",))),
    ("Water Temple MQ GS Freestanding Key Area",                     ("GS Token",     0x05,  0x08, None,                        'Golden Skull Token',                    ("Water Temple", "Master Quest", "Skulltulas",))),
    ("Water Temple MQ GS Triple Wall Torch",                         ("GS Token",     0x05,  0x10, None,                        'Golden Skull Token',                    ("Water Temple", "Master Quest", "Skulltulas",))),
    # Water Temple shared
    ...
    ("Shadow Temple GS Like Like Room",                              ("GS Token",     0x07,  0x08, None,                        'Golden Skull Token',                    ("Shadow Temple", "Vanilla", "Skulltulas",))),
    ("Shadow Temple GS Falling Spikes Room",                         ("GS Token",     0x07,  0x02, None,                        'Golden Skull Token',                    ("Shadow Temple", "Vanilla", "Skulltulas",))),
    ("Shadow Temple GS Single Giant Pot",                            ("GS Token",     0x07,  0x01, None,                        'Golden Skull Token',                    ("Shadow Temple", "Vanilla", "Skulltulas",))),
    ("Shadow Temple GS Near Ship",                                   ("GS Token",     0x07,  0x10, None,                        'Golden Skull Token',                    ("Shadow Temple", "Vanilla", "Skulltulas",))),
    ("Shadow Temple GS Triple Giant Pot",                            ("GS Token",     0x07,  0x04, None,                        'Golden Skull Token',                    ("Shadow Temple", "Vanilla", "Skulltulas",))),
    # Shadow Temple MQ
    ...
    ("Shadow Temple MQ GS Falling Spikes Room",                      ("GS Token",     0x07,  0x02, None,                        'Golden Skull Token',                    ("Shadow Temple", "Master Quest", "Skulltulas",))),
    ("Shadow Temple MQ GS Wind Hint Room",                           ("GS Token",     0x07,  0x01, None,                        'Golden Skull Token',                    ("Shadow Temple", "Master Quest", "Skulltulas",))),
    ("Shadow Temple MQ GS After Wind",                               ("GS Token",     0x07,  0x08, None,                        'Golden Skull Token',                    ("Shadow Temple", "Master Quest", "Skulltulas",))),
    ("Shadow Temple MQ GS After Ship",                               ("GS Token",     0x07,  0x10, None,                        'Golden Skull Token',                    ("Shadow Temple", "Master Quest", "Skulltulas",))),
    ("Shadow Temple MQ GS Near Boss",                                ("GS Token",     0x07,  0x04, None,                        'Golden Skull Token',                    ("Shadow Temple", "Master Quest", "Skulltulas",))),
    ...
    ("Spirit Temple GS Metal Fence",                                 ("GS Token",     0x06,  0x10, None,                        'Golden Skull Token',                    ("Spirit Temple", "Vanilla", "Skulltulas",))),
    ("Spirit Temple GS Sun on Floor Room",                           ("GS Token",     0x06,  0x08, None,                        'Golden Skull Token',                    ("Spirit Temple", "Vanilla", "Skulltulas",))),
    ("Spirit Temple GS Hall After Sun Block Room",                   ("GS Token",     0x06,  0x01, None,                        'Golden Skull Token',                    ("Spirit Temple", "Vanilla", "Skulltulas",))),
    ("Spirit Temple GS Lobby",                                       ("GS Token",     0x06,  0x04, None,                        'Golden Skull Token',                    ("Spirit Temple", "Vanilla", "Skulltulas",))),
    ("Spirit Temple GS Boulder Room",                                ("GS Token",     0x06,  0x02, None,                        'Golden Skull Token',                    ("Spirit Temple", "Vanilla", "Skulltulas",))),
    ("Spirit Temple MQ GS Sun Block Room",                           ("GS Token",     0x06,  0x01, None,                        'Golden Skull Token',                    ("Spirit Temple", "Master Quest", "Skulltulas",))),
    ("Spirit Temple MQ GS Leever Room",                              ("GS Token",     0x06,  0x02, None,                        'Golden Skull Token',                    ("Spirit Temple", "Master Quest", "Skulltulas",))),
    ("Spirit Temple MQ GS Symphony Room",                            ("GS Token",     0x06,  0x08, None,                        'Golden Skull Token',                    ("Spirit Temple", "Master Quest", "Skulltulas",))),
    ("Spirit Temple MQ GS Nine Thrones Room West",                   ("GS Token",     0x06,  0x04, None,                        'Golden Skull Token',                    ("Spirit Temple", "Master Quest", "Skulltulas",))),
    ("Spirit Temple MQ GS Nine Thrones Room North",                  ("GS Token",     0x06,  0x10, None,                        'Golden Skull Token',                    ("Spirit Temple", "Master Quest", "Skulltulas",))),
    ...
    ("Ice Cavern GS Spinning Scythe Room",                           ("GS Token",     0x09,  0x02, None,                        'Golden Skull Token',                    ("Ice Cavern", "Vanilla", "Skulltulas",))),
    ("Ice Cavern GS Heart Piece Room",                               ("GS Token",     0x09,  0x04, None,                        'Golden Skull Token',                    ("Ice Cavern", "Vanilla", "Skulltulas",))),
    ("Ice Cavern GS Push Block Room",                                ("GS Token",     0x09,  0x01, None,                        'Golden Skull Token',                    ("Ice Cavern", "Vanilla", "Skulltulas",))),
    # Ice Cavern MQ
    ...
    ("Ice Cavern MQ GS Red Ice",                                     ("GS Token",     0x09,  0x02, None,                        'Golden Skull Token',                    ("Ice Cavern", "Master Quest", "Skulltulas",))),
    ("Ice Cavern MQ GS Ice Block",                                   ("GS Token",     0x09,  0x04, None,                        'Golden Skull Token',                    ("Ice Cavern", "Master Quest", "Skulltulas",))),
    ("Ice Cavern MQ GS Scarecrow",                                   ("GS Token",     0x09,  0x01, None,                        'Golden Skull Token',                    ("Ice Cavern", "Master Quest", "Skulltulas",))),
