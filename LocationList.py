...
location_table: dict[str, tuple[str, Optional[int], LocationDefault, LocationAddresses, Optional[str], LocationFilterTags]] = OrderedDict([
    ...
    ## Overworld
    # Kokiri Forest
    ("KF Midos House Top Left Chest",                                ("Chest",        0x28,  0x00, None,                            'Rupees (5)',                            ("Kokiri Forest", "Forest Area", "Chests",))),
    ("KF Midos House Top Right Chest",                               ("Chest",        0x28,  0x01, None,                            'Rupees (5)',                            ("Kokiri Forest", "Forest Area", "Chests",))),
    ("KF Midos House Bottom Left Chest",                             ("Chest",        0x28,  0x02, None,                            'Rupee (1)',                             ("Kokiri Forest", "Forest Area", "Chests",))),
    ("KF Midos House Bottom Right Chest",                            ("Chest",        0x28,  0x03, None,                            'Recovery Heart',                        ("Kokiri Forest", "Forest Area", "Chests",))),
    ...
    ("LW Scrubs Grotto Deku Scrub Front",                            ("GrottoScrub",  0xF5,  0x79, None,                            'Deku Nut Capacity',                     ("Lost Woods", "Forest Area", "Deku Scrubs", "Deku Scrub Upgrades", "Grottos",))),
    ("LW Scrubs Grotto Deku Scrub Rear",                             ("GrottoScrub",  0xF5,  0x33, None,                            'Buy Deku Seeds (30)',                   ("Lost Woods", "Forest Area", "Deku Scrubs", "Grottos",))),
    ...
    ("SFM Storms Grotto Deku Scrub Front",                           ("GrottoScrub",  0xEE,  0x3A, None,                            'Buy Green Potion',                      ("Sacred Forest Meadow", "Forest Area", "Deku Scrubs", "Grottos",))),
    ("SFM Storms Grotto Deku Scrub Rear",                            ("GrottoScrub",  0xEE,  0x39, None,                            'Buy Red Potion for 30 Rupees',          ("Sacred Forest Meadow", "Forest Area", "Deku Scrubs", "Grottos",))),
    ...
    ("HF Inside Fence Grotto Deku Scrub",                            ("GrottoScrub",  0xE6,  0x3E, None,                            'Piece of Heart',                        ("Hyrule Field", "Deku Scrubs", "Deku Scrub Upgrades", "Grottos",))),
    ("HF Cow Grotto Cow",                                            ("NPC",          0x3E,  0x16, None,                            'Milk',                                  ("Hyrule Field", "Cows", "Grottos",))),
    ("HF Cow Grotto GS",                                             ("GS Token",     0x0A,  0x01, None,                            'Gold Skulltula Token',                  ("Hyrule Field", "Gold Skulltulas", "Grottos",))),
    ("HF Near Kak Grotto GS",                                        ("GS Token",     0x0A,  0x02, None,                            'Gold Skulltula Token',                  ("Hyrule Field", "Gold Skulltulas", "Grottos",))),
    # Hyrule Field Pots
    ...
    ("Market Guard House 10 Big Poes",                               ("NPC",          0x4D,  0x0F, None,                            'Bottle',                                ("Market", "NPCs",))),
    ("Market Guard House GS",                                        ("GS Token",     0x0E,  0x08, None,                            'Gold Skulltula Token',                  ("Market", "Gold Skulltulas",))),
    ...
    ("Temple of Time Light Arrow Cutscene",                          ("Cutscene",     0xFF,  0x01, None,                            'Light Arrows',                          ("Temple of Time", "NPCs",))),
    # Market Pots/Crates
    ...
    ("HC Storms Grotto GS",                                          ("GS Token",     0x0E,  0x02, None,                            'Gold Skulltula Token',                  ("Hyrule Castle", "Gold Skulltulas", "Grottos",))),
    ...
    ("LLR Talons House Chickens",                                    ("NPC",          0x4C,  0x14, None,                            'Bottle with Milk',                      ("Lon Lon Ranch", "Minigames",))),
    ("LLR Tower Freestanding PoH",                                   ("Collectable",  0x4C,  0x01, None,                            'Piece of Heart',                        ("Lon Lon Ranch", "Freestandings",))),
    ("LLR Grotto Deku Scrub Left",                                   ("GrottoScrub",  0xFC,  0x30, None,                            'Buy Deku Nut (5)',                      ("Lon Lon Ranch", "Deku Scrubs", "Grottos",))),
    ("LLR Grotto Deku Scrub Center",                                 ("GrottoScrub",  0xFC,  0x33, None,                            'Buy Deku Seeds (30)',                   ("Lon Lon Ranch", "Deku Scrubs", "Grottos",))),
    ("LLR Grotto Deku Scrub Right",                                  ("GrottoScrub",  0xFC,  0x37, None,                            'Buy Bombs (5) for 35 Rupees',           ("Lon Lon Ranch", "Deku Scrubs", "Grottos",))),
    ...
    ("Kak Odd Medicine Building Trade Odd Mushroom",                 ("NPC",          0x4E,  0x20, None,                            'Odd Potion',                            ("Kakariko Village", "Kakariko",))),
    ("Kak Odd Medicine Building Buy Blue Potion",                    ("NPC",          0x4E,  0x12, None,                            'Blue Potion',                           ("Kakariko Village", "Kakariko",))),
    ...
    ("Kak House of Skulltula 10 Gold Skulltula Reward",              ("NPC",          0x50,  0x45, None,                            'Progressive Wallet',                    ("Kakariko Village", "Skulltula House", "NPCs",))),
    ("Kak House of Skulltula 20 Gold Skulltula Reward",              ("NPC",          0x50,  0x39, None,                            'Stone of Agony',                        ("Kakariko Village", "Skulltula House", "NPCs",))),
    ("Kak House of Skulltula 30 Gold Skulltula Reward",              ("NPC",          0x50,  0x46, None,                            'Progressive Wallet',                    ("Kakariko Village", "Skulltula House", "NPCs",))),
    ("Kak House of Skulltula 40 Gold Skulltula Reward",              ("NPC",          0x50,  0x03, None,                            'Bombchus (10)',                         ("Kakariko Village", "Skulltula House", "NPCs",))),
    ("Kak House of Skulltula 50 Gold Skulltula Reward",              ("NPC",          0x50,  0x3E, None,                            'Piece of Heart',                        ("Kakariko Village", "Skulltula House", "NPCs",))),
    ...
    ("Graveyard Dampes Grave Hookshot Chest",                        ("Chest",        0x48,  0x00, None,                            'Progressive Hookshot',                  ("Graveyard", "Grottos", "Minigames", "Chests",))),
    ("Graveyard Dampes Grave Freestanding PoH",                      ("Collectable",  0x48,  0x07, None,                            'Piece of Heart',                        ("Graveyard", "Grottos", "Minigames", "Freestandings",))),
    ...
    ("Graveyard Dampes Grave Rupee 1",                               ("Freestanding", 0x48,  (1,0,1), None,                         'Rupee (1)',                             ("Graveyard", "Grottos", "Freestandings",))),
    ("Graveyard Dampes Grave Rupee 2",                               ("Freestanding", 0x48,  (1,0,2), None,                         'Rupee (1)',                             ("Graveyard", "Grottos", "Freestandings",))),
    ("Graveyard Dampes Grave Rupee 3",                               ("Freestanding", 0x48,  (1,0,3), None,                         'Rupee (1)',                             ("Graveyard", "Grottos", "Freestandings",))),
    ("Graveyard Dampes Grave Rupee 4",                               ("Freestanding", 0x48,  (2,0,1), None,                         'Rupee (1)',                             ("Graveyard", "Grottos", "Freestandings",))),
    ("Graveyard Dampes Grave Rupee 5",                               ("Freestanding", 0x48,  (2,0,2), None,                         'Rupee (1)',                             ("Graveyard", "Grottos", "Freestandings",))),
    ("Graveyard Dampes Grave Rupee 6",                               ("Freestanding", 0x48,  (2,0,3), None,                         'Rupee (1)',                             ("Graveyard", "Grottos", "Freestandings",))),
    ("Graveyard Dampes Grave Rupee 7",                               ("Freestanding", 0x48,  (3,0,1), None,                         'Rupee (1)',                             ("Graveyard", "Grottos", "Freestandings",))),
    ("Graveyard Dampes Grave Rupee 8",                               ("Freestanding", 0x48,  (3,0,2), None,                         'Rupee (1)',                             ("Graveyard", "Grottos", "Freestandings",))),
    ...
    ("Graveyard Dampes Grave Pot 1",                                 ("Pot",          0x48,  (0,0,1), None,                         'Recovery Heart',                        ("Graveyard", "Grottos", "Pots",))),
    ("Graveyard Dampes Grave Pot 2",                                 ("Pot",          0x48,  (0,0,2), None,                         'Deku Nuts (5)',                         ("Graveyard", "Grottos", "Pots",))),
    ("Graveyard Dampes Grave Pot 3",                                 ("Pot",          0x48,  (0,0,3), None,                         'Bombs (5)',                             ("Graveyard", "Grottos", "Pots",))),
    ("Graveyard Dampes Grave Pot 4",                                 ("Pot",          0x48,  (0,0,4), None,                         'Arrows (10)',                           ("Graveyard", "Grottos", "Pots",))),
    ("Graveyard Dampes Grave Pot 5",                                 ("Pot",          0x48,  (0,0,5), None,                         'Rupees (20)',                           ("Graveyard", "Grottos", "Pots",))),
    ("Graveyard Dampes Grave Pot 6",                                 ("Pot",          0x48,  (0,0,6), None,                         'Rupees (20)',                           ("Graveyard", "Grottos", "Pots",))),

    # Graveyard Wonderitems
    ("Graveyard Dampes Grave Wonderitem 1",                          ("Wonderitem",   0x48, (1,0,6), None,                          'Rupees (5)',                            ("Graveyard", "Grottos", "Wonderitem"))),
    ("Graveyard Dampes Grave Wonderitem 2",                          ("Wonderitem",   0x48, (1,0,7), None,                          'Rupees (5)',                            ("Graveyard", "Grottos", "Wonderitem"))),
    ("Graveyard Dampes Grave Wonderitem 3",                          ("Wonderitem",   0x48, (1,0,8), None,                          'Rupees (5)',                            ("Graveyard", "Grottos", "Wonderitem"))),
    ("Graveyard Dampes Grave Wonderitem 4",                          ("Wonderitem",   0x48, (1,0,9), None,                          'Rupees (5)',                            ("Graveyard", "Grottos", "Wonderitem"))),
    ("Graveyard Dampes Grave Wonderitem 5",                          ("Wonderitem",   0x48, (1,0,10), None,                         'Rupees (5)',                            ("Graveyard", "Grottos", "Wonderitem"))),
    ("Graveyard Dampes Grave Wonderitem 6",                          ("Wonderitem",   0x48, (2,0,8), None,                          'Rupees (5)',                            ("Graveyard", "Grottos", "Wonderitem"))),
    ("Graveyard Dampes Grave Wonderitem 7",                          ("Wonderitem",   0x48, (2,0,9), None,                          'Rupees (5)',                            ("Graveyard", "Grottos", "Wonderitem"))),
    ("Graveyard Dampes Grave Wonderitem 8",                          ("Wonderitem",   0x48, (2,0,10), None,                         'Rupees (5)',                            ("Graveyard", "Grottos", "Wonderitem"))),
    ("Graveyard Dampes Grave Wonderitem 9",                          ("Wonderitem",   0x48, (2,0,11), None,                         'Rupees (5)',                            ("Graveyard", "Grottos", "Wonderitem"))),
    ("Graveyard Dampes Grave Wonderitem 10",                         ("Wonderitem",   0x48, (2,0,12), None,                         'Rupees (5)',                            ("Graveyard", "Grottos", "Wonderitem"))),
    ("Graveyard Dampes Grave Wonderitem 11",                         ("Wonderitem",   0x48, (3,0,9), None,                          'Rupees (5)',                            ("Graveyard", "Grottos", "Wonderitem"))),
    ("Graveyard Dampes Grave Wonderitem 12",                         ("Wonderitem",   0x48, (3,0,10), None,                         'Rupees (5)',                            ("Graveyard", "Grottos", "Wonderitem"))),
    ("Graveyard Dampes Grave Wonderitem 13",                         ("Wonderitem",   0x48, (3,0,11), None,                         'Rupees (5)',                            ("Graveyard", "Grottos", "Wonderitem"))),
    ("Graveyard Dampes Grave Wonderitem 14",                         ("Wonderitem",   0x48, (3,0,12), None,                         'Rupees (5)',                            ("Graveyard", "Grottos", "Wonderitem"))),
    ("Graveyard Dampes Grave Wonderitem 15",                         ("Wonderitem",   0x48, (3,0,13), None,                         'Rupees (5)',                            ("Graveyard", "Grottos", "Wonderitem"))),
    ...
    ("GC Grotto Deku Scrub Left",                                    ("GrottoScrub",  0xFB,  0x30, None,                            'Buy Deku Nut (5)',                      ("Goron City", "Deku Scrubs", "Grottos",))),
    ("GC Grotto Deku Scrub Center",                                  ("GrottoScrub",  0xFB,  0x33, None,                            'Buy Arrows (30)',                       ("Goron City", "Deku Scrubs", "Grottos",))),
    ("GC Grotto Deku Scrub Right",                                   ("GrottoScrub",  0xFB,  0x37, None,                            'Buy Bombs (5) for 35 Rupees',           ("Goron City", "Deku Scrubs", "Grottos",))),
    ...
    ("DMC Hammer Grotto Deku Scrub Left",                            ("GrottoScrub",  0xF9,  0x30, None,                            'Buy Deku Nut (5)',                      ("Death Mountain Crater", "Deku Scrubs", "Grottos",))),
    ("DMC Hammer Grotto Deku Scrub Center",                          ("GrottoScrub",  0xF9,  0x33, None,                            'Buy Arrows (30)',                       ("Death Mountain Crater", "Deku Scrubs", "Grottos",))),
    ("DMC Hammer Grotto Deku Scrub Right",                           ("GrottoScrub",  0xF9,  0x37, None,                            'Buy Bombs (5) for 35 Rupees',           ("Death Mountain Crater", "Deku Scrubs", "Grottos",))),
    ...
    ("ZR Storms Grotto Deku Scrub Front",                            ("GrottoScrub",  0xEB,  0x3A, None,                            'Buy Green Potion',                      ("Zora's River", "Deku Scrubs", "Grottos",))),
    ("ZR Storms Grotto Deku Scrub Rear",                             ("GrottoScrub",  0xEB,  0x39, None,                            'Buy Red Potion for 30 Rupees',          ("Zora's River", "Deku Scrubs", "Grottos",))),
    ...
    ("LH Fishing Hole Child Reward",                                 ("NPC",          0x49,  0x3E, None,                            'Piece of Heart',                        ("Lake Hylia", "Minigames",))),
    ("LH Fishing Hole Adult Reward",                                 ("NPC",          0x49,  0x38, None,                            'Progressive Scale',                     ("Lake Hylia", "Minigames",))),
    ("LH Fishing Hole Loach Reward",                                 ("NPC",          0x49,  0x56, None,                            'Rupees (50)',                           ("Lake Hylia", "Minigames"))),
    ("LH Lab Dive",                                                  ("NPC",          0x38,  0x3E, None,                            'Piece of Heart',                        ("Lake Hylia", "NPCs",))),
    ("LH Lab Trade Eyeball Frog",                                    ("NPC",          0x38,  0x25, None,                            'Eyedrops',                              ("Lake Hylia",))),
    ...
    ("LH Grotto Deku Scrub Left",                                    ("GrottoScrub",  0xEF,  0x30, None,                            'Buy Deku Nut (5)',                      ("Lake Hylia", "Deku Scrubs", "Grottos",))),
    ("LH Grotto Deku Scrub Center",                                  ("GrottoScrub",  0xEF,  0x33, None,                            'Buy Deku Seeds (30)',                   ("Lake Hylia", "Deku Scrubs", "Grottos",))),
    ("LH Grotto Deku Scrub Right",                                   ("GrottoScrub",  0xEF,  0x37, None,                            'Buy Bombs (5) for 35 Rupees',           ("Lake Hylia", "Deku Scrubs", "Grottos",))),
    ...
    ("LH Lab GS Crate",                                              ("GS Token",     0x12,  0x08, None,                            'Gold Skulltula Token',                  ("Lake Hylia", "Gold Skulltulas",))),
    ...
    ("GV Storms Grotto Deku Scrub Front",                            ("GrottoScrub",  0xF0,  0x3A, None,                            'Buy Green Potion',                      ("Gerudo Valley", "Deku Scrubs", "Grottos",))),
    ("GV Storms Grotto Deku Scrub Rear",                             ("GrottoScrub",  0xF0,  0x39, None,                            'Buy Red Potion for 30 Rupees',          ("Gerudo Valley", "Deku Scrubs", "Grottos",))),
    ...
    ("Colossus Grotto Deku Scrub Front",                             ("GrottoScrub",  0xFD,  0x3A, None,                            'Buy Green Potion',                      ("Desert Colossus", "Deku Scrubs", "Grottos",))),
    ("Colossus Grotto Deku Scrub Rear",                              ("GrottoScrub",  0xFD,  0x39, None,                            'Buy Red Potion for 30 Rupees',          ("Desert Colossus", "Deku Scrubs", "Grottos",))),
    ...
    ("OGC Great Fairy Fountain Reward",                              ("Cutscene",     0xFF,  0x15, None,                            'Double Defense',                        ("Outside Ganon's Castle", "Great Fairies",))),
...
# Mapping of old location names to current ones for better plando backwards compatibility
LOCATION_ALIASES: dict[str, str] = {
    "KF Midos Top Left Chest":               "KF Midos House Top Left Chest",
    "KF Midos Top Right Chest":              "KF Midos House Top Right Chest",
    "KF Midos Bottom Left Chest":            "KF Midos House Bottom Left Chest",
    "KF Midos Bottom Right Chest":           "KF Midos House Bottom Right Chest",
    "LW Deku Scrub Grotto Front":            "LW Scrubs Grotto Deku Scrub Front",
    "LW Deku Scrub Grotto Rear":             "LW Scrubs Grotto Deku Scrub Rear",
    "SFM Deku Scrub Grotto Front":           "SFM Storms Grotto Deku Scrub Front",
    "SFM Deku Scrub Grotto Rear":            "SFM Storms Grotto Deku Scrub Rear",
    "HF Deku Scrub Grotto":                  "HF Inside Fence Grotto Deku Scrub",
    "HF GS Cow Grotto":                      "HF Cow Grotto GS",
    "HF GS Near Kak Grotto":                 "HF Near Kak Grotto GS",
    "Market 10 Big Poes":                    "Market Guard House 10 Big Poes",
    "Market GS Guard House":                 "Market Guard House GS",
    "ToT Light Arrows Cutscene":             "Temple of Time Light Arrow Cutscene",
    "HC Great Fairy Reward":                 "HC Great Fairy Fountain Reward",
    "HC GS Storms Grotto":                   "HC Storms Grotto GS",
    "LLR Talons Chickens":                   "LLR Talons House Chickens",
    "LLR Freestanding PoH":                  "LLR Tower Freestanding PoH",
    "LLR Deku Scrub Grotto Left":            "LLR Grotto Deku Scrub Left",
    "LLR Deku Scrub Grotto Center":          "LLR Grotto Deku Scrub Center",
    "LLR Deku Scrub Grotto Right":           "LLR Grotto Deku Scrub Right",
    "Kak Granny Trade Odd Mushroom":         "Kak Odd Medicine Building Trade Odd Mushroom",
    "Kak Granny Buy Blue Potion":            "Kak Odd Medicine Building Buy Blue Potion",
    "Kak 10 Gold Skulltula Reward":          "Kak House of Skulltula 10 Gold Skulltula Reward",
    "Kak 20 Gold Skulltula Reward":          "Kak House of Skulltula 20 Gold Skulltula Reward",
    "Kak 30 Gold Skulltula Reward":          "Kak House of Skulltula 30 Gold Skulltula Reward",
    "Kak 40 Gold Skulltula Reward":          "Kak House of Skulltula 40 Gold Skulltula Reward",
    "Kak 50 Gold Skulltula Reward":          "Kak House of Skulltula 50 Gold Skulltula Reward",
    "Graveyard Dampe Race Hookshot Chest":   "Graveyard Dampes Grave Hookshot Chest",
    "Graveyard Dampe Race Freestanding PoH": "Graveyard Dampes Grave Freestanding PoH",
    "Graveyard Dampe Race Rupee 1":          "Graveyard Dampes Grave Rupee 1",
    "Graveyard Dampe Race Rupee 2":          "Graveyard Dampes Grave Rupee 2",
    "Graveyard Dampe Race Rupee 3":          "Graveyard Dampes Grave Rupee 3",
    "Graveyard Dampe Race Rupee 4":          "Graveyard Dampes Grave Rupee 4",
    "Graveyard Dampe Race Rupee 5":          "Graveyard Dampes Grave Rupee 5",
    "Graveyard Dampe Race Rupee 6":          "Graveyard Dampes Grave Rupee 6",
    "Graveyard Dampe Race Rupee 7":          "Graveyard Dampes Grave Rupee 7",
    "Graveyard Dampe Race Rupee 8":          "Graveyard Dampes Grave Rupee 8",
    "Graveyard Dampe Pot 1":                 "Graveyard Dampes Grave Pot 1",
    "Graveyard Dampe Pot 2":                 "Graveyard Dampes Grave Pot 2",
    "Graveyard Dampe Pot 3":                 "Graveyard Dampes Grave Pot 3",
    "Graveyard Dampe Pot 4":                 "Graveyard Dampes Grave Pot 4",
    "Graveyard Dampe Pot 5":                 "Graveyard Dampes Grave Pot 5",
    "Graveyard Dampe Pot 6":                 "Graveyard Dampes Grave Pot 6",
    "Graveyard Dampe Race Wonderitem 1":     "Graveyard Dampes Grave Wonderitem 1",
    "Graveyard Dampe Race Wonderitem 2":     "Graveyard Dampes Grave Wonderitem 2",
    "Graveyard Dampe Race Wonderitem 3":     "Graveyard Dampes Grave Wonderitem 3",
    "Graveyard Dampe Race Wonderitem 4":     "Graveyard Dampes Grave Wonderitem 4",
    "Graveyard Dampe Race Wonderitem 5":     "Graveyard Dampes Grave Wonderitem 5",
    "Graveyard Dampe Race Wonderitem 6":     "Graveyard Dampes Grave Wonderitem 6",
    "Graveyard Dampe Race Wonderitem 7":     "Graveyard Dampes Grave Wonderitem 7",
    "Graveyard Dampe Race Wonderitem 8":     "Graveyard Dampes Grave Wonderitem 8",
    "Graveyard Dampe Race Wonderitem 9":     "Graveyard Dampes Grave Wonderitem 9",
    "Graveyard Dampe Race Wonderitem 10":    "Graveyard Dampes Grave Wonderitem 10",
    "Graveyard Dampe Race Wonderitem 11":    "Graveyard Dampes Grave Wonderitem 11",
    "Graveyard Dampe Race Wonderitem 12":    "Graveyard Dampes Grave Wonderitem 12",
    "Graveyard Dampe Race Wonderitem 13":    "Graveyard Dampes Grave Wonderitem 13",
    "Graveyard Dampe Race Wonderitem 14":    "Graveyard Dampes Grave Wonderitem 14",
    "Graveyard Dampe Race Wonderitem 15":    "Graveyard Dampes Grave Wonderitem 15",
    "DMT Great Fairy Reward":                "DMT Great Fairy Fountain Reward",
    "GC Deku Scrub Grotto Left":             "GC Grotto Deku Scrub Left",
    "GC Deku Scrub Grotto Center":           "GC Grotto Deku Scrub Center",
    "GC Deku Scrub Grotto Right":            "GC Grotto Deku Scrub Right",
    "DMC Great Fairy Reward":                "DMC Great Fairy Fountain Reward",
    "DMC Deku Scrub Grotto Left":            "DMC Hammer Grotto Deku Scrub Left",
    "DMC Deku Scrub Grotto Center":          "DMC Hammer Grotto Deku Scrub Center",
    "DMC Deku Scrub Grotto Right":           "DMC Hammer Grotto Deku Scrub Right",
    "ZR Deku Scrub Grotto Front":            "ZR Storms Grotto Deku Scrub Front",
    "ZR Deku Scrub Grotto Rear":             "ZR Storms Grotto Deku Scrub Rear",
    "ZF Great Fairy Reward":                 "ZF Great Fairy Fountain Reward",
    "LH Child Fishing":                      "LH Fishing Hole Child Reward",
    "LH Adult Fishing":                      "LH Fishing Hole Adult Reward",
    "LH Loach Fishing":                      "LH Fishing Hole Loach Reward",
    "LH Trade Eyeball Frog":                 "LH Lab Trade Eyeball Frog",
    "LH Deku Scrub Grotto Left":             "LH Grotto Deku Scrub Left",
    "LH Deku Scrub Grotto Center":           "LH Grotto Deku Scrub Center",
    "LH Deku Scrub Grotto Right":            "LH Grotto Deku Scrub Right",
    "LH GS Lab Crate":                       "LH Lab GS Crate",
    "GV Deku Scrub Grotto Front":            "GV Storms Grotto Deku Scrub Front",
    "GV Deku Scrub Grotto Rear":             "GV Storms Grotto Deku Scrub Rear",
    "Colossus Great Fairy Reward":           "Colossus Great Fairy Fountain Reward",
    "Colossus Deku Scrub Grotto Front":      "Colossus Grotto Deku Scrub Front",
    "Colossus Deku Scrub Grotto Rear":       "Colossus Grotto Deku Scrub Rear",
    "OGC Great Fairy Reward":                "OGC Great Fairy Fountain Reward",
}
