...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Upgradeful Hookshot':                             ('Item',     True,  0x0119, {'alias': ('Progressive Hookshot', 2), 'progressive': 2}),
    'Upgradeful Strength':                             ('Item',     True,  0x011A, {'alias': ('Progressive Strength Upgrade', 3), 'progressive': 3}),
    'Upgradeful Bomb Bag':                             ('Item',     True,  0x011B, {'alias': ('Bomb Bag', 3), 'progressive': 3}),
    'Upgradeful Bow':                                  ('Item',     True,  0x011C, {'alias': ('Bow', 3), 'progressive': 3}),
    'Upgradeful Slingshot':                            ('Item',     True,  0x011D, {'alias': ('Slingshot', 3), 'progressive': 3}),
    'Upgradeful Wallet':                               ('Item',     True,  0x011E, {'alias': ('Progressive Wallet', 3), 'progressive': 3}),
    'Upgradeful Scale':                                ('Item',     True,  0x011F, {'alias': ('Progressive Scale', 2), 'progressive': 2}),
    'Upgradeful Nut':                                  ('Item',     True,  0x0120, {'alias': ('Deku Nut Capacity', 2), 'progressive': 2}),
    'Upgradeful Stick':                                ('Item',     True,  0x0121, {'alias': ('Deku Stick Capacity', 2), 'progressive': 2}),
    'Upgradeful Bombchu':                              ('Item',     True,  0x0122, {'alias': ('Bombchus', 1), 'progressive': 1}),
    'Upgradeful Magic':                                ('Item',     True,  0x0123, {'alias': ('Magic Meter', 2), 'progressive': 2}),
    'Upgradeful Ocarina':                              ('Item',     True,  0x0124, {'alias': ('Ocarina', 2), 'progressive': 2}),
