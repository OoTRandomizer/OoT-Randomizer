...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Bombchus (10)':                                   ('Item',     True,  GetItemId.GI_BOMBCHUS_10, {'market_price': 99}),
    ...
    'Bombchus (5)':                                    ('Item',     True,  GetItemId.GI_BOMBCHUS_5, {'market_price': 60}),
    'Bombchus (20)':                                   ('Item',     True,  GetItemId.GI_BOMBCHUS_20, {'market_price': 180}),
