...
class State(object):
    ...
    def can_live_dmg(self, damage):
        ...
        health = self.world.settings.starting_hearts
        return self.world.settings.damage_multiplier != 'ohko' and (damage < health or (damage / 2 < health and self.has('Double Defense')))
