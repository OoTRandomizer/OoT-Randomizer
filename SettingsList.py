...
setting_infos = [
    ...
    Checkbutton(
        ...
        disable        = {
            True : {
                ...
                'settings': ['starting_age', 'shuffle_interior_entrances', 'shuffle_hideout_entrances', 'shuffle_grotto_entrances',
                             'shuffle_dungeon_entrances', 'shuffle_bosses', 'shuffle_overworld_entrances', 'owl_drops', 'warp_songs', 'spawn_positions',
    ...
    Combobox(
        ...
        disable        = {
            ...
            'glitched'  : {'settings' : ['allowed_tricks', 'shuffle_interior_entrances', 'shuffle_hideout_entrances',
                                         'shuffle_grotto_entrances', 'shuffle_dungeon_entrances', 'shuffle_overworld_entrances',
                                         'owl_drops', 'warp_songs', 'spawn_positions', 'mq_dungeons_mode', 'mq_dungeons_specific',
    ...
    Checkbutton(
        ...
        gui_tooltip    = '''\
            ...
            always takes you to the first room (with a cell and 1 torch).
