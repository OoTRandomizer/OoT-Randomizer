...
setting_infos = [
    ...
    Combobox(
        ...
        disable={
            ...
            'lacs_stones':      {'settings': ['triforce_hunt', 'lacs_medallions', 'lacs_rewards', 'lacs_tokens']},
            'lacs_medallions':  {'settings': ['triforce_hunt', 'lacs_stones', 'lacs_rewards', 'lacs_tokens']},
            'lacs_dungeons':    {'settings': ['triforce_hunt', 'lacs_medallions', 'lacs_stones', 'lacs_tokens']},
            'lacs_tokens':      {'settings': ['triforce_hunt', 'lacs_medallions', 'lacs_stones', 'lacs_rewards']},
        },
        gui_params     = {
            'randomize_key': 'randomize_settings',
            'distribution': [
