...
ITEM_MESSAGES = {
    0x0001:    ("\x08\x06\x30\x05\x41TEXT ID ERROR!\x05\x40", "<<##\x01テキストエラー！##\x00"),
    0x9001:    ("\x08\x13\x2DYou borrowed a \x05\x41Pocket Egg\x05\x40!\x01A Pocket Cucco will hatch from\x01it overnight. Be sure to give it\x01back.", "<<~~\x2Dポケットタマゴをお借りした。&&一夜明けたらコッコがかえる。"),
    0x0002:    ("\x08\x13\x2FYou returned the Pocket Cucco\x01and got \x05\x41Cojiro\x05\x40 in return!\x01Unlike other Cuccos, Cojiro\x01rarely crows.", "<<~~\x2Fてのりコッコをお返しして&&##\x01コジロー##\x00を入手！&&めったに鳴かないコッコだ！"),
    0x0003:    ("\x08\x13\x30You got an \x05\x41Odd Mushroom\x05\x40!\x01It is sure to spoil quickly! Take\x01it to the Kakariko Potion Shop.", "<<~~\x30##\x01あやしいキノコ##\x00を入手！&&クスリ屋へ急げ！"),
    0x0004:    ("\x08\x13\x31You received an \x05\x41Odd Potion\x05\x40!\x01It may be useful for something...\x01Hurry to the Lost Woods!", "<<~~\x31##\x01あやしいクスリ##\x00を入手！&&迷いの森に　急ごう！"),
    0x0005:    ("\x08\x13\x32You returned the Odd Potion \x01and got the \x05\x41Poacher's Saw\x05\x40!\x01The young punk guy must have\x01left this.", "<<~~\x32あやしいクスリを返して&&##\x01密猟者のノコギリ##\x00を入手！&&不良の兄ちゃんの残した物だ。"),
    ...
    0x0008:    ("\x08\x13\x33You traded the Poacher's Saw \x01for a \x05\x41Broken Goron's Sword\x05\x40!\x01Visit Biggoron to get it repaired!", "<<~~\x33密猟者のノコギリをわたして&&##\x01折れたゴロン刀##\x00を入手！&&ダイゴロンに直してもらおう！"),
    0x0009:    ("\x08\x13\x34You checked in the Broken \x01Goron's Sword and received a \x01\x05\x41Prescription\x05\x40!\x01Go see King Zora!", "<<~~\x34折れたゴロン刀をあずけて&&##\x01処方せん##\x00を入手！&&キングゾーラに会おう！"),
    0x000A:    ("\x08\x13\x37The Biggoron's Sword...\x01You got a \x05\x41Claim Check \x05\x40for it!\x01You can't wait for the sword!", "<<~~\x37剛剣ダイゴロン刀！！&&…の##\x01ひきかえ券##\x00を入手。&&完成が待ちどおしい！"),
    0x000B:    ("\x08\x13\x2EYou got a \x05\x41Pocket Cucco, \x05\x40one\x01of Anju's prized hens! It fits \x01in your pocket.", "<<~~\x2E##\x01てのりコッコ##\x00を入手！&&目覚ましにもなるぞ！"),
    0x000C:    ("\x08\x13\x3DYou got the \x05\x41Biggoron's Sword\x05\x40!\x01This blade was forged by a \x01master smith and won't break!", "<<~~\x3D巨人のナイフと　交換で&&剛剣##\x01ダイゴロン刀##\x00を入手！&&絶対折れないぞ！"),
    0x000D:    ("\x08\x13\x35You used the Prescription and\x01received an \x05\x41Eyeball Frog\x05\x40!\x01Be quick and deliver it to Lake \x01Hylia!", "<<~~\x35処方せんを渡して&&##\x01メダマガエル##\x00を入手！&&ハイリア湖に急げ！"),
    0x000E:    ("\x08\x13\x36You traded the Eyeball Frog \x01for the \x05\x41World's Finest Eye Drops\x05\x40!\x01Hurry! Take them to Biggoron!", "<<~~\x36メダマガエルを渡して&&##\x01特製本生目薬##\x00を入手！&&ダイゴロンの所に急げ！"),
    ...
    0x0014:    ("\x08\x13\x28You borrowed a \x05\x41Goron Mask\x05\x40.\x01It will make your head look\x01big, though.", "<<~~\x28##\x01ゴロンのお面##\x00を借りた！&&ちょっとカオがデカいです。"),
    0x0015:    ("\x08\x13\x29You borrowed a \x05\x41Zora Mask\x05\x40.\x01With this mask, you can\x01become one of the Zoras!", "<<~~\x29##\x01ゾーラのお面##\x00を借りた！&&これでアナタも　ゾーラ族。"),
    0x0016:    ("\x08\x13\x2AYou borrowed a \x05\x41Gerudo Mask\x05\x40.\x01This mask will make you look\x01like...a girl?", "<<~~\x2A##\x01ゲルドのお面##\x00を借りた！&&これでアナタも　オネエさん？"),
    ...
    0x0032:    ("\x08\x13\x02You got \x05\x41Bombs\x05\x40!\x01If you see something\x01suspicious, bomb it!", "<<~~\x02##\x01バクダン##\x00を入手！&&ドカンと一発　気持ちイイ！"),
    ...
    0x0036:    ("\x08\x13\x0AYou found the \x05\x41Hookshot\x05\x40!\x01It's a spring-loaded chain that\x01you can cast out to hook things.", "<<~~\x0A##\x01フックショット##\x00を入手！&&伸ばして引掛けろ！&&引き寄せたり、引かれたり。"),
    ...
    0x0042:    ("\x08\x13\x14You got an \x05\x41Empty Bottle\x05\x40!\x01You can put something in this\x01bottle.", "<<~~\x14##\x01あきビン##\x00を入手！&&色々と便利！"),
    ...
    0x0046:    ("\x08\x13\x18You caught a \x05\x41Fairy\x05\x40 in a bottle!\x01It will revive you\x01the moment you run out of life \x01energy.", "<<~~\x18##\x01妖精##\x00をビンにつめた！&&倒れた時に助けてくれる"),
    0x0047:    ("\x08\x13\x19You got a \x05\x41Fish\x05\x40!\x01It looks so fresh and\x01delicious!", "<<~~\x19##\x01サカナ##\x00をビンにつめた！&&とれとれピチピチおいしそう！"),
    ...
    0x0050:    ("\x08\x13\x42You got a \x05\x41Goron Tunic\x05\x40!\x01Going to a hot place? No worry!", "<<~~\x42##\x01ゴロンの服##\x00を入手！&&アツい所もへっちゃらだ！"),
    0x0051:    ("\x08\x13\x43You got a \x05\x43Zora Tunic\x05\x40!\x01Wear it, and you won't drown\x01underwater.", "<<~~\x43##\x03ゾーラの服##\x00を入手！&&水中でも苦しゅうない！"),
    0x0052:    ("\x08You got a \x05\x42Magic Jar\x05\x40!\x01Your Magic Meter is filled!", "<<##\x02魔法のツボ##\x00を入手！&&魔力が回復する！"),
    0x0053:    ("\x08\x13\x45You got the \x05\x41Iron Boots\x05\x40!\x01So heavy, you can't run.\x01So heavy, you can't float.", "<<~~\x45##\x01ヘビィブーツ##\x00を入手！&&重くて、走れぬ、浮かべぬ。"),
    0x0054:    ("\x08\x13\x46You got the \x05\x41Hover Boots\x05\x40!\x01With these mysterious boots\x01you can hover above the ground.", "<<~~\x46##\x01ホバーブーツ##\x00を入手！&&地面に浮かぶ不思議なブーツ。"),
    ...
    0x005D:    ("\x08\x13\x1CYou put a \x05\x44Blue Fire\x05\x40\x01into the bottle!\x01This is a cool flame you can\x01use on red ice.", "<<~~\x1C##\x04青い炎##\x00をビンにつめた！&&赤い氷を溶かせるゾ。"),
    ...
    0x0070:    ("\x08\x13\x04You got the \x05\x41Fire Arrow\x05\x40!\x01If you hit your target,\x01it will catch fire.", "<<~~\x04##\x01炎の矢##\x00を入手！&&命中すれば燃え上がる！！"),
    ...
    0x0097:    ("\x08\x13\x20You caught a \x05\x41Poe \x05\x40in a bottle!\x01Something good might happen!", "<<~~\x20##\x01ポウ##\x00をビンにつめた！&&何か良いことあるかも。"),
    ...
    0x0099:    ("\x08\x13\x1BYou found \x05\x41Ruto's Letter\x05\x40 in a\x01bottle! Show it to King Zora.", "<<~~\x1B##\x01ルトの手紙##\x00を入手！&&キングゾーラに見せよう！"),
    ...
    0x009A:    ("\x08\x13\x21You got a \x05\x41Weird Egg\x05\x40!\x01Feels like there's something\x01moving inside!", "<<~~\x21##\x01ふしぎなタマゴ##\x00を入手！&&なんかゴトゴト動いてる。"),
    0x00A4:    ("\x08\x13\x3BYou got the \x05\x42Kokiri Sword\x05\x40!\x01This is a hidden treasure of\x01the Kokiri.", "<<~~\x3B##\x02コキリの剣##\x00を入手した！&&コキリの仲間の宝物。"),
    ...
    0x00AD:    ("\x08\x13\x05You got \x05\x41Din's Fire\x05\x40!\x01Its fireball engulfs everything!", "<<~~\x05##\x01ディンの炎##\x00を入手！&&炎のドームが全てを包む！"),
    0x00AE:    ("\x08\x13\x0DYou got \x05\x42Farore's Wind\x05\x40!\x01This is warp magic you can use!", "<<~~\x0D##\x02フロルの風##\x00を入手！&&使えばその場を脱出だ！"),
    0x00AF:    ("\x08\x13\x13You got \x05\x43Nayru's Love\x05\x40!\x01Cast this to create a powerful\x01protective barrier.", "<<~~\x13##\x03ネールの愛##\x00を入手！&&聖なる衣が身を守る！"),
    ...
    0x00CD:    ("\x08\x13\x53You got the \x05\x43Silver Scale\x05\x40!\x01You can dive deeper than you\x01could before.", "<<~~\x53##\x03銀のウロコ##\x00を入手！&&前より深く潜れるぞ！"),
    0x00CE:    ("\x08\x13\x54You got the \x05\x43Golden Scale\x05\x40!\x01Now you can dive much\x01deeper than you could before!", "<<~~\x54##\x03金のウロコ##\x00を入手！&&とことん深く潜れるぞ！"),
...
KEYSANITY_MESSAGES = {
    0x001C:    ("\x13\x74\x08You got the \x05\x41Boss Key\x05\x40\x01for the \x05\x41Fire Temple\x05\x40!\x09", "~~\x74<<##\x01炎の神殿##\x00の##\x01ボスキー##\x00を入手！>>"),
    0x0006:    ("\x13\x74\x08You got the \x05\x41Boss Key\x05\x40\x01for the \x05\x42Forest Temple\x05\x40!\x09", "~~\x74<<##\x02森の神殿##\x00の##\x01ボスキー##\x00を入手！>>"),
    0x001D:    ("\x13\x74\x08You got the \x05\x41Boss Key\x05\x40\x01for the \x05\x43Water Temple\x05\x40!\x09", "~~\x74<<##\x03水の神殿##\x00の##\x01ボスキー##\x00を入手！>>"),
    0x001E:    ("\x13\x74\x08You got the \x05\x41Boss Key\x05\x40\x01for the \x05\x46Spirit Temple\x05\x40!\x09", "~~\x74<<##\x06魂の神殿##\x00の##\x01ボスキー##\x00を入手！>>"),
    0x002A:    ("\x13\x74\x08You got the \x05\x41Boss Key\x05\x40\x01for the \x05\x45Shadow Temple\x05\x40!\x09", "~~\x74<<##\x05闇の神殿##\x00の##\x01ボスキー##\x00を入手！>>"),
    0x0061:    ("\x13\x74\x08You got the \x05\x41Boss Key\x05\x40\x01for \x05\x41Ganon's Castle\x05\x40!\x09", "~~\x74<<##\x01ガノン城##\x00の##\x01ボスキー##\x00を入手！>>"),
    0x0062:    ("\x13\x75\x08You found the \x05\x41Compass\x05\x40\x01for the \x05\x42Deku Tree\x05\x40!\x09", "~~\x75<<##\x02デクの樹##\x00の##\x01コンパス##\x00を入手！>>"),
    0x0063:    ("\x13\x75\x08You found the \x05\x41Compass\x05\x40\x01for \x05\x41Dodongo's Cavern\x05\x40!\x09", "~~\x75<<##\x01ドドンゴ##\x00の##\x01コンパス##\x00を入手！>>"),
    0x0064:    ("\x13\x75\x08You found the \x05\x41Compass\x05\x40\x01for \x05\x43Jabu Jabu's Belly\x05\x40!\x09", "~~\x75<<##\x03ジャブジャブ##\x00の##\x01コンパス##\x00を入手！>>"),
    0x0065:    ("\x13\x75\x08You found the \x05\x41Compass\x05\x40\x01for the \x05\x42Forest Temple\x05\x40!\x09", "~~\x75<<##\x02森の神殿##\x00の##\x01コンパス##\x00を入手！>>"),
    0x007C:    ("\x13\x75\x08You found the \x05\x41Compass\x05\x40\x01for the \x05\x41Fire Temple\x05\x40!\x09", "~~\x75<<##\x01炎の神殿##\x00の##\x01コンパス##\x00を入手！>>"),
    0x007D:    ("\x13\x75\x08You found the \x05\x41Compass\x05\x40\x01for the \x05\x43Water Temple\x05\x40!\x09", "~~\x75<<##\x03水の神殿##\x00の##\x01コンパス##\x00を入手！>>"),
    0x007E:    ("\x13\x75\x08You found the \x05\x41Compass\x05\x40\x01for the \x05\x46Spirit Temple\x05\x40!\x09", "~~\x75<<##\x06魂の神殿##\x00の##\x01コンパス##\x00を入手！>>"),
    0x007F:    ("\x13\x75\x08You found the \x05\x41Compass\x05\x40\x01for the \x05\x45Shadow Temple\x05\x40!\x09", "~~\x75<<##\x05闇の神殿##\x00の##\x01コンパス##\x00を入手！>>"),
    0x0087:    ("\x13\x75\x08You found the \x05\x41Compass\x05\x40\x01for the \x05\x44Ice Cavern\x05\x40!\x09", "~~\x75<<##\x04氷の洞窟##\x00の##\x01コンパス##\x00を入手！>>"),
    0x0088:    ("\x13\x76\x08You found the \x05\x41Dungeon Map\x05\x40\x01for the \x05\x42Deku Tree\x05\x40!\x09", "~~\x76<<##\x02デクの樹##\x00の##\x01地図##\x00を入手！>>"),
    0x0089:    ("\x13\x76\x08You found the \x05\x41Dungeon Map\x05\x40\x01for \x05\x41Dodongo's Cavern\x05\x40!\x09", "~~\x76<<##\x01ドドンゴ##\x00の##\x01地図##\x00を入手！>>"),
    0x008A:    ("\x13\x76\x08You found the \x05\x41Dungeon Map\x05\x40\x01for \x05\x43Jabu Jabu's Belly\x05\x40!\x09", "~~\x76<<##\x03ジャブジャブ##\x00の##\x01地図##\x00を入手！>>"),
    0x008B:    ("\x13\x76\x08You found the \x05\x41Dungeon Map\x05\x40\x01for the \x05\x42Forest Temple\x05\x40!\x09", "~~\x76<<##\x02森の神殿##\x00の##\x01地図##\x00を入手！>>"),
    0x008C:    ("\x13\x76\x08You found the \x05\x41Dungeon Map\x05\x40\x01for the \x05\x41Fire Temple\x05\x40!\x09", "~~\x76<<##\x01炎の神殿##\x00の##\x01地図##\x00を入手！>>"),
    0x008E:    ("\x13\x76\x08You found the \x05\x41Dungeon Map\x05\x40\x01for the \x05\x43Water Temple\x05\x40!\x09", "~~\x76<<##\x03水の神殿##\x00の##\x01地図##\x00を入手！>>"),
    0x008F:    ("\x13\x76\x08You found the \x05\x41Dungeon Map\x05\x40\x01for the \x05\x46Spirit Temple\x05\x40!\x09", "~~\x76<<##\x06魂の神殿##\x00の##\x01地図##\x00を入手！>>"),
    0x0092:    ("\x13\x76\x08You found the \x05\x41Dungeon Map\x05\x40\x01for the \x05\x44Ice Cavern\x05\x40!\x09", "~~\x76<<##\x04氷の洞窟##\x00の##\x01地図##\x00を入手！>>"),
    0x0093:    ("\x13\x77\x08You found a \x05\x41Small Key\x05\x40\x01for the \x05\x42Forest Temple\x05\x40!\x09", "~~\x77<<##\x02森の神殿##\x00の##\x01カギ##\x00を入手！>>"),
    0x0094:    ("\x13\x77\x08You found a \x05\x41Small Key\x05\x40\x01for the \x05\x41Fire Temple\x05\x40!\x09", "~~\x77<<##\x01炎の神殿##\x00の##\x01カギ##\x00を入手！>>"),
    0x0095:    ("\x13\x77\x08You found a \x05\x41Small Key\x05\x40\x01for the \x05\x43Water Temple\x05\x40!\x09", "~~\x77<<##\x03水の神殿##\x00の##\x01カギ##\x00を入手！>>"),
    0x009B:    ("\x13\x77\x08You found a \x05\x41Small Key\x05\x40\x01for the \x05\x45Bottom of the Well\x05\x40!\x09", "~~\x77<<##\x05井戸の下##\x00の##\x01カギ##\x00を入手！>>"),
    0x009F:    ("\x13\x77\x08You found a \x05\x41Small Key\x05\x40\x01for the \x05\x46Gerudo Training\x01Ground\x05\x40!\x09", "~~\x77<<##\x06修練場##\x00の##\x01カギ##\x00を入手！>>"),
    0x00A0:    ("\x13\x77\x08You found a \x05\x41Small Key\x05\x40\x01for the \x05\x46Thieves' Hideout\x05\x40!\x09", "~~\x77<<##\x06盗賊団##\x00の##\x01カギ##\x00を入手！>>"),
    0x00A1:    ("\x13\x77\x08You found a \x05\x41Small Key\x05\x40\x01for \x05\x41Ganon's Castle\x05\x40!\x09", "~~\x77<<##\x01ガノン城##\x00の##\x01カギ##\x00を入手！>>"),
    0x00A2:    ("\x13\x75\x08You found the \x05\x41Compass\x05\x40\x01for the \x05\x45Bottom of the Well\x05\x40!\x09", "~~\x75<<##\x05井戸の下##\x00の##\x01コンパス##\x00を入手！>>"),
    0x00A3:    ("\x13\x76\x08You found the \x05\x41Dungeon Map\x05\x40\x01for the \x05\x45Shadow Temple\x05\x40!\x09", "~~\x76<<##\x05闇の神殿##\x00の##\x01地図##\x00を入手！>>"),
...
MISC_MESSAGES = {
    ...
    0x100D:    (None, "<<妖精は　人や　物に　向かって&&飛んで行くヨ！", 0x03, "center"),
    0x1015:    (None, "<<リンクよ…&&今、ここで　お前の勇気を&&ためさせてほしい。", 0x03, "center"),
    0x1016:    (None, "<<覚悟は　あるかな…？>>:2##\x02&&はい&&いいえ##\x00", 0x03, "left"),
    0x101C:    (None, "<<ボクに　ソレ　ゆずれよ。>>&&:2##\x02はい&&いやだ##\x00", 0x00, "left"),
    0x1036:    (None, "<<画面右上に　表示される&&３つの　黄色いアイコンは&&##\x06Ｃアイコン##\x00だヨ。", 0x03, "center"),
    0x104D:    (None, "<<$$\x38\x80ピッ！！", 0x03, "center"),
    0x1052:    (None, "<<おニイちゃん、&&デクの盾は　使えないヨ。", 0x00, "center"),
    0x1055:    (None, "<<フーン…　おニイちゃん…&&森に　はいっても　ヘーキなんダ。}}\x10\x56", 0x00, "center"),
    0x1058:    (None, "<<おニイちゃん、旅のヒト？}}\x10\x59", 0x00, "center"),
    0x105B:    (None, "<<おニイちゃん、&&@Nってコ&&知らない？}}\x10\x5C", 0x00, "center"),
    0x105D:    (None, "<<おっきくなって　強くなって…&&デクナッツとか　やっつけたいな。&&でも…}}\x10\x5E", 0x00, "center"),
    0x1060:    (None, "<<なんだ、オマエ！？", 0x00, "center"),
    0x1062:    (None, "<<ボク、##\x01デクの樹のこども##\x00　デス！", 0x00, "center"),
    0x1070:    (None, "<<@Nが　帰ってきたら&&サリアが　ずっと　待ってたこと…&&ぜったい　おしえてやる！}}\x10\x71", 0x00, "center"),
    0x109A:    (None, "<<…なんだっけ", 0x03, "center"),
    0x10A8:    (None, "<<ここで　あの曲　ふくと&&妖精たちと　お話しできるのよ。}}\\x10\\xA9", 0x03, "center"),
    0x10AB:    (None, "<<そんなこと　言わないで　やろ～よ！", 0x03, "center"),
    0x10B0:    (None, "<<サリアのコトなら&&ミドが　知ってるかもネ。", 0x00, "center"),
    0x10B8:    (None, "<<返して！:2##\x02&&はい&&いいえ##\x00", 0x00, "left"),
    0x10C1:    (None, "<<この　迷いの森を　ぬけると&&そこは　##\x02森の聖域##\x00。", 0x03, "center"),
    0x10C9:    (None, "<<もしものコトも　あるし、&&武器は　あったほうが　いいわネ。}}\x10\x32", 0x00, "center"),
    0x10D0:    (None, "<<なに～っ！？&&デクの樹サマに　呼ばれたって？}}\\x10\\xD1", 0x00, "center"),
    0x10D2:    (None, "<<なんだ、##\x04デクの盾##\x00つけてるじゃん。&&そ…　それ、「##\x02コキリの剣##\x00」？&&ちっくしょーっ！！}}\\x10\\xD3", 0x00, "center"),
    0x10D3:    (None, "<<でもヨ、そんなモン　持ってたって&&ヨワいやつは　ヨワいんだかんナ！}}\x10\x32", 0x00, "center"),
    0x10D6:    (None, "<<それから　ついでに…&&イジワルして…&&ゴメン！　って…サ。", 0x00, "center"),
    0x10D8:    (None, "<<見て、イイけしきでしょ？", 0x00, "center"),
    0x200D:    (None, "<<ぼーやにゃ　世話になったから、&&ウチのじまんの##\x01これ##\x00　やるだーよ。", 0x03, "center"),
    0x202E:    (None, "$$\x48\x07<<もらった分から&&お面の代金　##\x01５０ルピー##\x00だけを　&&お面屋に　納めに　戻ろう。", 0x23, "center"),
    0x2032:    (None, "<<そうかい。", 0x00, "center"),
    0x2039:    (None, "<<金のないヤツとは　勝負できね～な！", 0x00, "center"),
    0x2040:    (None, "<<あ～あ　雇われ人は　辛いよな。", 0x00, "center"),
    0x2042:    (None, "<<マロンはネ、とーさん　まってるの。&&とーさん、お城に牛乳届けに&&入ったまま　出てこないんダ…", 0x00, "center"),
    0x2046:    (None, "<<怠け者のタロンのオヤジより&&この##\x01インゴー様##\x00の方が　牧場の&&オーナーにゃ相応しいよナ。", 0x00, "center"),
    0x2057:    (None, "<<ＺＺＺＺＺＺＺＺ…", 0x00, "center"),
    ...
    0x3017:    (None, "<<今、アニキは…&&自分の部屋に　閉じこもってるゴロ。", 0x00, "center"),
    0x3019:    (None, "<<そういえば　アニキ　よく&&##\x02森から流れてくる歌##\x00を&&聞いてたゴロなあ…}}\x30\x2C", 0x00, "center"),
    0x3020:    (None, "<<う～ん、ちょっとちがうゴロ…", 0x03, "center"),
    0x3022:    (None, "<<棒に火を点けたままにしとくと&&燃え尽きてなくなるゴロよ。", 0x00, "center"),
    0x3025:    (None, "<<投げて落とせば　よかったのね…", 0x00, "center"),
    0x302A:    (None, "<<このあたりの話を　聞きたいなら&&オラたちの町に　行けばいいゴロ。", 0x00, "center"),
    0x302F:    (None, "<<オマエ、この穴の奥から&&聞こえてくる曲、知ってるゴロ？&&オラたち　コレが　お気に入りゴロ。", 0x00, "center"),
    0x3034:    (None, "<<なにを　聞く？:2##\x02&&リュウについて&&ゴロンたちについて##\x00", 0x20, "left"),
    0x3038:    (None, "<<##\x01神サマの像##\x00を　うごかすコロ！", 0x00, "center"),
    0x3042:    (None, "<<オラも　おっきくなったら&&つよ～いオトコに　なるコロ！", 0x00, "center"),
    0x304B:    (None, "<<５、６年　待ってほしいゴロ。", 0x00, "center"),
    0x3056:    (None, "<<あぁ～&&もう　だめゴロォ～！", 0x03, "center"),
    ...
    0x4009:    (None, "<<ジャブジャブさまは　ゾーラの神。&&お食事のしたくは&&##\x01ルト姫サマ##\x00の　担当だったんだ。", 0x00, "center"),
    ...
    0x4013:    (None, "<<ルト姫は　ハイリア湖を&&調べたいと　言っておったゾラ…&&心配だゾラ…", 0x03, "center"),
    ...
    0x4022:    (None, "<<チョッピリ…&&ココロぼそかったゾラ…", 0x00, "center"),
    0x405F:    (None, "<<１つぶ　##\x01２０ルピー##\x00　でどう？:2##\x02&&かう&&やめとく##\x00", 0x00, "left"),
    0x4060:    (None, "<<１つぶ　##\x01３０ルピー##\x00　でどう？:2##\x02&&かう&&やめとく##\x00", 0x00, "left"),
    0x4061:    (None, "<<１つぶ　##\x01４０ルピー##\x00　でどう？:2##\x02&&かう&&やめとく##\x00", 0x00, "left"),
    0x4062:    (None, "<<１つぶ　##\x01５０ルピー##\x00　でどう？:2##\x02&&かう&&やめとく##\x00", 0x00, "left"),
    0x4063:    (None, "<<１つぶ　##\x01６０ルピー##\x00　でどう？:2##\x02&&かう&&やめとく##\x00", 0x00, "left"),
    0x4064:    (None, "<<１つぶ　##\x01７０ルピー##\x00　でどう？:2##\x02&&かう&&やめとく##\x00", 0x00, "left"),
    0x4065:    (None, "<<１つぶ　##\x01８０ルピー##\x00　でどう？:2##\x02&&かう&&やめとく##\x00", 0x00, "left"),
    0x4066:    (None, "<<１つぶ　##\x01９０ルピー##\x00　でどう？:2##\x02&&かう&&やめとく##\x00", 0x00, "left"),
    0x4067:    (None, "<<１つぶ　##\x01１００ルピー##\x00　でどう？:2##\x02&&かう&&やめとく##\x00", 0x00, "left"),
    0x5011:    (None, "<<もう一度　聞く？:2##\x02&&はい&&いいえ##\x00", 0x00, "left"),
    0x5015:    (None, "<<ＺＺＺ…", 0x00, "center"),
    0x501C:    (None, "<<@N、&&大変なことに　なった…&&##\x01闇の魔物##\x00が　復活したんだ！", 0x03, "center"),
    0x5041:    (None, "<<こう見えても　オラは　自信あり！&&ココで　オラと　競争するだ。&&ついてこれるもんなら　ついてきな！", 0x00, "center"),
    0x5046:    (None, "<<魔法使いの　バアちゃんも&&裏で　クスリ屋　やってるんだ。{{", 0x03, "center"),
    0x5054:    (None, "<<もう　おりたくありませ～ん！", 0x00, "center"),
    0x5058:    (None, "<<もし、ニワトリのコトで　何か&&ねーちゃんに頼まれたら&&聞いてやれよ。", 0x03, "center"),
    0x505A:    (None, "<<このコ、ニワトリの世話してるけど&&本当は　トリアレルギーなんだぜ。", 0x03, "center"),
    0x505F:    (None, "<<インパ様は　いらっしゃらないよ。", 0x03, "center"),
    0x5061:    (None, "<<あそこで寝てる&&ヒゲのオヤジさんにも&&色々あるんだよ、きっと。", 0x03, "center"),
    0x5067:    (None, "<<ピン　ポン　パン　ポン！&&ただいま　@T　です。", 0x00, "center"),
    0x508D:    (None, "<<リチャードちゃんを　知らない？&&有名な　おイヌちゃん　ザマス！&&ほんとに　知らないザマスか？", 0x03, "center"),
    0x6019:    (None, "<<なんで　こんなとこに　きたんだい？&&ま…アタイも言えないけどサ。}}\x60\x1A", 0x00, "center"),
    0x6023:    (None, "<<アタイは、ゲルド族の　##\x01ナボール##\x00。&&一匹オオカミの　盗賊さ。}}\x60\x24", 0x00, "center"),
    0x6044:    (None, "<<信じられない！！&&お前こそ　究極の達人だ。&&達人に　ふさわしい武具を与えよう！", 0x00, "center"),
    0x6046:    (None, "<<素晴らしい！！&&お前こそ　真の達人。&&達人に　ふさわしい物を与えよう！", 0x00, "center"),
    0x605B:    (None, "<<もう、ゲルドなんて　コリゴリ！&&あと##\x01３人##\x00、仲間が　捕まってるから&&助けてやってね。　たのんだわよ！", 0x00, "center"),
    0x605C:    (None, "<<もう　こんなとこ　サヨナラよ！&&あと##\x01２人##\x00、仲間が　捕まってるから&&助けてやってね。　たのむわね！", 0x00, "center"),
    0x605D:    (None, "<<はやく　かえって　安心させなきゃ。&&あと##\x01１人##\x00、仲間が　捕まってるから&&助けてやってね。　おねがいね！", 0x00, "center"),
    0x605E:    (None, "<<アタイだけ　忘れられたんじゃ&&ないかと　思ったわ。　よかった！", 0x00, "center"),
    0x6062:    (None, "<<今じゃ、ナボールの盗賊団は&&冷酷・非情・残忍の代名詞。&&義賊なんて　聞いてあきれるわ。", 0x03, "center"),
    0x6065:    (None, "<<砦で　やぶさめに挑戦してみた？&&自分の馬が　あるなら&&砦で　受け付けてるわよ。", 0x03, "center"),
    0x606B:    (None, "<<ゲルドの砦へ　行くなら&&オレっちの仲間の　様子を&&見てきてくれねぇか？", 0x00, "center"),
    0x607A:    (None, "<<この先　おまえの勇気に&&ハイラルの　すべての民の&&未来が　かかっておる。}}\x60\x7B", 0x03, "center"),
    0x607C:    (None, "<<ワシは　お前を見守ってゆく&&今までも…　これからもな…&&ホホ～ッ！", 0x03, "center"),
    0x7004:    (None, "<<たいくつだ…&&もっと　世の中に　モメごとが&&あるほうが　楽しいぜ、きっと…", 0x00, "center"),
    0x7019:    (None, "<<城の右奥に　忍び込めそうな&&##\x01小さな水路##\x00を　見つけたけど&&抜けらんなくなったんだ～！", 0x00, "center"),
    0x701D:    (None, "<<##\x04時の神殿##\x00って　知ってる？}}\x70\x1E", 0x00, "center"),
    0x701E:    (None, "<<時の神殿は　聖地への入口だ、という&&言い伝えが　あるのよ。", 0x00, "center"),
    0x7020:    (None, "<<このバカのせいで　お城の警備が&&キビしく　なったんだぜ！", 0x00, "center"),
    0x7028:    (None, "<<##\x01ゼルダ姫##\x00に　お会いしたいだと？^^<<かえれ！　かえれ！&&姫がお前のような者に&&お会いになるわけないわ！", 0x00, "center"),
    0x7037:    (None, "<<そう…　時の神殿とは、&&この地上から　聖地へ入るための&&入口なのです。{{", 0x03, "center"),
...
def name_replace(text):
    if r"\x86\xc7" in text:
        split = text.split(r"\x86\xc7\x00")
        p = 1
        while p <= text.count(r"\x86\xc7"):
            i = split[p].count(r"\x83\x8a\x83\x93\x83\x4e") + split[p].count(r"\x82\xe8\x82\xf1\x82\xad") + split[p].count(r"\x82\xa0\x82\xc8\x82\xbd") + split[p].count(r"\x83\x41\x83\x69\x83\x5e")
            split[p] = split[p].replace(r"\x83\x8a\x83\x93\x83\x4e",r"\x87\x4f")
            split[p] = split[p].replace(r"\x82\xe8\x82\xf1\x82\xad",r"\x87\x4f")
            split[p] = split[p].replace(r"\x82\xa0\x82\xc8\x82\xbd",r"\x87\x4f")
            split[p] = split[p].replace(r"\x83\x41\x83\x69\x83\x5e",r"\x87\x4f")
            f = split[p][:4]
            num = int(f.replace("\\x",""), 16)
            new_num = format(num - (40 * i),"02x")
            if "-" in new_num:
                split[p] = split[p][4:]
            else:
                new_f = r"\x86\xc7\x00\x{}".format(new_num)
                split[p] = new_f + split[p][4:]
            p += 1
        text = "".join(split)
    return text
    ...
    with open(temporal, "r+")as red:
        for id, (text, opt, tag, ending) in new_jp.items():
            ...
            if offset % 2 == 0:
                ...
                raise(TypeError("Message ID 0x" + "{:04x}".format(id) + " has some mistake!"))
