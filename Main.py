...
def build_world_graphs(settings, window=dummy_window()):
    ...
    for id, world in enumerate(worlds):
        ...
        overworld_data.replace("(Gold_Skulltula_Token, 10)","(Gold_Skulltula_Token, " + str(10 * (1 + settings.logical_skulls_needed/10)) + ")")
        overworld_data.replace("(Gold_Skulltula_Token, 20)","(Gold_Skulltula_Token, " + str(20 * (1 + settings.logical_skulls_needed/10)) + ")")
        overworld_data.replace("(Gold_Skulltula_Token, 30)","(Gold_Skulltula_Token, " + str(30 * (1 + settings.logical_skulls_needed/10)) + ")")
        overworld_data.replace("(Gold_Skulltula_Token, 40)","(Gold_Skulltula_Token, " + str(40 * (1 + settings.logical_skulls_needed/10)) + ")")
        overworld_data.replace("(Gold_Skulltula_Token, 50)","(Gold_Skulltula_Token, " + str(50 * (1 + settings.logical_skulls_needed/10)) + ")")
