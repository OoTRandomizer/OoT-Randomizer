...
texture_t texture_table[TEXTURE_ID_MAX] = {
    ...
    [TEXTURE_ID_TREE_GILDED] = { .textureID = TEXTURE_ID_TREE_GILDED },
    [TEXTURE_ID_TREE_SILVER] = { .textureID = TEXTURE_ID_TREE_SILVER },
    [TEXTURE_ID_TREE_GOLD] = { .textureID = TEXTURE_ID_TREE_GOLD },
    [TEXTURE_ID_TREE_SKULL] = { .textureID = TEXTURE_ID_TREE_SKULL },
    [TEXTURE_ID_TREE_HEART] = { .textureID = TEXTURE_ID_TREE_HEART },
};
