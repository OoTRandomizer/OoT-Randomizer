...
item_row_t item_table[] = {
    ...
    [0x45] = ITEM_ROW(0x53, 0, 0x56, 0x005E, 0x00D1, 0x22, no_upgrade, no_effect, -1, -1), // Adult's Wallet
    [0x46] = ITEM_ROW(0x53, 0, 0x57, 0x005F, 0x00D1, 0x23, no_upgrade, no_effect, -1, -1), // Giant's Wallet
