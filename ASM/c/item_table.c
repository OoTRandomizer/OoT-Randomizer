...
item_row_t item_table[] = {
    ...
    [0x0043] = ITEM_ROW(0x53,       BROWN_CHEST, 0x78, -1, 0x0052, 0x00CD, 0x1E, magic_jar_to_rupee, no_effect, -1, -1, NULL), // Small Magic Jar
    [0x0044] = ITEM_ROW(0x53,       BROWN_CHEST, 0x79, -1, 0x0052, 0x00CD, 0x1F, magic_jar_to_rupee, no_effect, -1, -1, NULL), // Large Magic Jar
