...
from Rom import Rom
from Utils import default_output_path, is_bundled, run_process, user_cache_path
...
def apply_ootr_3_web_patch(settings, rom: Rom) -> None:
    ...
    if minibsdiff_python:
        ...
        run_process(logger, [minibsdiff_path, "app", user_cache_path('ZOOTDEC.z64'), decompressed_patch_file, decompressed_patched_rom_file])
