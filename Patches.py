...
def patch_rom(spoiler: Spoiler, world: World, rom: Rom) -> Rom:
    ...
    crate_textures = [
        ...
        (31, 'texture_tree_gilded',         0x012E1F90,    None,            1024,   rgba16_patch,               'textures/tree/tree_gilded_rgba16_patch.bin'),
        (32, 'texture_tree_silver',         0x012E1F90,    None,            1024,   rgba16_patch,               'textures/tree/tree_silver_rgba16_patch.bin'),
        (33, 'texture_tree_gold',           0x012E1F90,    None,            1024,   rgba16_patch,               'textures/tree/tree_gold_rgba16_patch.bin'),
        (34, 'texture_tree_skull',          0x012E1F90,    None,            1024,   rgba16_patch,               'textures/tree/tree_skull_rgba16_patch.bin'),
        (35, 'texture_tree_heart',          0x012E1F90,    None,            1024,   rgba16_patch,               'textures/tree/tree_heart_rgba16_patch.bin'),
    ]
...
def get_override_entry(location: Location) -> Optional[OverrideEntry]:
    ...
    if location.type in ('ActorOverride', 'Freestanding', 'RupeeTower', 'Pot', 'Crate', 'FlyingPot', 'SmallCrate', 'Beehive', 'Wonderitem', 'Tree') and location.locked:
        return None
    ...
    if location.type in ('NPC', 'Scrub', 'BossHeart'):
        ...
        type = 1
        default &= 0x1F
    elif location.type in ('Freestanding', 'Pot', 'Crate', 'FlyingPot', 'SmallCrate', 'RupeeTower', 'Beehive', 'SilverRupee', 'Wonderitem', 'Tree'):
        type = 6
