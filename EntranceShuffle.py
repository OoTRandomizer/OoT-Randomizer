...
entrance_shuffle_table = [
    ...
    ('Dungeon',         ('DMC Fire Temple Exit -> Fire Temple Lower',                       { 'index': 0x0165 }),
    ...
    ('Interior',        ('DMC Fairy Fountain Exit -> DMC Great Fairy Fountain',             { 'index': 0x04BE }),
    ...
    ('Grotto',          ('DMC Hammer Grotto Exit -> DMC Hammer Grotto',                     { 'grotto_id': 0x05, 'entrance': 0x05A4, 'content': 0xF9, 'scene': 0x61 }),
                        ('DMC Hammer Grotto -> DMC Near Hammer Grotto',                     { 'grotto_id': 0x05 })),
    ('Grotto',          ('DMC Upper Grotto Exit -> DMC Upper Grotto',                       { 'grotto_id': 0x06, 'entrance': 0x003F, 'content': 0x7A, 'scene': 0x61 }),
    ...
    ('Overworld',       ('GC Darunias Chamber -> DMC Near Darunias Chamber',                { 'index': 0x0246 }),
                        ('DMC Darunias Chamber Exit -> GC Darunias Chamber',                { 'index': 0x01C1 })),
    ('Overworld',       ('Death Mountain Summit -> DMC Near Death Mountain Summit',         { 'index': 0x0147 }),
                        ('DMC Death Mountain Summit Exit -> Death Mountain Summit',         { 'index': 0x01BD })),
