...
entrance_shuffle_table = [
    ...
    ('Interior',        ('DMC Near Great Fairy Fountain -> DMC Great Fairy Fountain',       { 'index': 0x04BE }),
    ...
    ('Grotto',          ('DMC Near Hammer Grotto -> DMC Hammer Grotto',                     { 'grotto_id': 0x05, 'entrance': 0x05A4, 'content': 0xF9, 'scene': 0x61 }),
                        ('DMC Hammer Grotto -> DMC Near Hammer Grotto',                     { 'grotto_id': 0x05 })),
    ('Grotto',          ('DMC Near Upper Grotto -> DMC Upper Grotto',                       { 'grotto_id': 0x06, 'entrance': 0x003F, 'content': 0x7A, 'scene': 0x61 }),
    ...
    ('Overworld',       ('GC Darunias Chamber -> DMC Near Darunias Chamber',                { 'index': 0x0246 }),
                        ('DMC Near Darunias Chamber -> GC Darunias Chamber',                { 'index': 0x01C1 })),
    ('Overworld',       ('Death Mountain Summit -> DMC Near Death Mountain Summit',         { 'index': 0x0147 }),
                        ('DMC Near Death Mountain Summit -> Death Mountain Summit',         { 'index': 0x01BD })),
