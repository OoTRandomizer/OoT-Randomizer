...
entrance_shuffle_table = [
    ...
    ('Grotto',          ('Zora River -> ZR Storms Grotto',                                  { 'entrance': 0x05BC, 'content': 0xEB, 'scene': 0x54, 'add_exit': True }),
                        ('ZR Storms Grotto -> Zora River',                                  {})),
    ('Grotto',          ('Zora River -> ZR Fairy Grotto',                                   { 'entrance': 0x036D, 'content': 0xE6, 'scene': 0x54, 'add_exit': True }),
                        ('ZR Fairy Grotto -> Zora River',                                   {})),
    ('Grotto',          ('Zora River -> ZR Open Grotto',                                    { 'entrance': 0x003F, 'content': 0x29, 'scene': 0x54, 'add_exit': True }),
                        ('ZR Open Grotto -> Zora River',                                    {})),
    ('Grotto',          ('DMC Lower Nearby -> DMC Hammer Grotto',                           { 'entrance': 0x05A4, 'content': 0xF9, 'scene': 0x61, 'add_exit': True }),
                        ('DMC Hammer Grotto -> DMC Lower Local',                            {})),
    ('Grotto',          ('DMC Upper Nearby -> DMC Upper Grotto',                            { 'entrance': 0x003F, 'content': 0x7A, 'scene': 0x61, 'add_exit': True }),
                        ('DMC Upper Grotto -> DMC Upper Local',                             {})),
    ('Grotto',          ('GC Grotto Platform -> GC Grotto',                                 { 'entrance': 0x05A4, 'content': 0xFB, 'scene': 0x62, 'add_exit': True }),
                        ('GC Grotto -> GC Grotto Platform',                                 {})), #TODO (out-of-logic access to Goron City)
    ('Grotto',          ('Death Mountain -> DMT Storms Grotto',                             { 'entrance': 0x003F, 'content': 0x57, 'scene': 0x60, 'add_exit': True }),
                        ('DMT Storms Grotto -> Death Mountain',                             {})),
    ('Grotto',          ('Death Mountain Summit -> DMT Cow Grotto',                         { 'entrance': 0x05FC, 'content': 0xF8, 'scene': 0x60 }),
                        ('DMT Cow Grotto -> Death Mountain Summit',                         {})),
    ('Grotto',          ('Kak Backyard -> Kak Open Grotto',                                 { 'entrance': 0x003F, 'content': 0x28, 'scene': 0x52, 'add_exit': True }),
                        ('Kak Open Grotto -> Kak Backyard',                                 {})),
    ('Grotto',          ('Kakariko Village -> Kak Redead Grotto',                           { 'entrance': 0x05A0, 'content': 0xE7, 'scene': 0x52 }),
                        ('Kak Redead Grotto -> Kakariko Village',                           {})),
    ('Grotto',          ('Hyrule Castle Grounds -> HC Storms Grotto',                       { 'entrance': 0x05B8, 'content': 0xF6, 'scene': 0x5F }),
                        ('HC Storms Grotto -> Castle Grounds',                              {})),
    ('Grotto',          ('Hyrule Field -> HF Tektite Grotto',                               { 'entrance': 0x05C0, 'content': 0xE1, 'scene': 0x51 }),
                        ('HF Tektite Grotto -> Hyrule Field',                               {})),
    ('Grotto',          ('Hyrule Field -> HF Near Kak Grotto',                              { 'entrance': 0x0598, 'content': 0xE5, 'scene': 0x51 }),
                        ('HF Near Kak Grotto -> Hyrule Field',                              {})),
    ('Grotto',          ('Hyrule Field -> HF Fairy Grotto',                                 { 'entrance': 0x036D, 'content': 0xFF, 'scene': 0x51, 'add_exit': True }),
                        ('HF Fairy Grotto -> Hyrule Field',                                 {})),
    ('Grotto',          ('Hyrule Field -> HF Near Market Grotto',                           { 'entrance': 0x003F, 'content': 0x00, 'scene': 0x51, 'add_exit': True }),
                        ('HF Near Market Grotto -> Hyrule Field',                           {})),
    ('Grotto',          ('Hyrule Field -> HF Cow Grotto',                                   { 'entrance': 0x05A8, 'content': 0xE4, 'scene': 0x51 }),
                        ('HF Cow Grotto -> Hyrule Field',                                   {})),
    ('Grotto',          ('Hyrule Field -> HF Inside Fence Grotto',                          { 'entrance': 0x059C, 'content': 0xE6, 'scene': 0x51 }),
                        ('HF Inside Fence Grotto -> Hyrule Field',                          {})),
    ('Grotto',          ('Hyrule Field -> HF Open Grotto',                                  { 'entrance': 0x003F, 'content': 0x03, 'scene': 0x51, 'add_exit': True }),
                        ('HF Open Grotto -> Hyrule Field',                                  {})),
    ('Grotto',          ('Hyrule Field -> HF Southeast Grotto',                             { 'entrance': 0x003F, 'content': 0x22, 'scene': 0x51, 'add_exit': True }),
                        ('HF Southeast Grotto -> Hyrule Field',                             {})),
    ('Grotto',          ('Lon Lon Ranch -> LLR Grotto',                                     { 'entrance': 0x05A4, 'content': 0xFC, 'scene': 0x63, 'add_exit': True }),
                        ('LLR Grotto -> Lon Lon Ranch',                                     {})),
    ('Grotto',          ('SFM Entryway -> SFM Wolfos Grotto',                               { 'entrance': 0x05B4, 'content': 0xED, 'scene': 0x56 }),
                        ('SFM Wolfos Grotto -> SFM Entryway',                               {})),
    ('Grotto',          ('Sacred Forest Meadow -> SFM Storms Grotto',                       { 'entrance': 0x05BC, 'content': 0xEE, 'scene': 0x56, 'add_exit': True }),
                        ('SFM Storms Grotto -> Sacred Forest Meadow',                       {})),
    ('Grotto',          ('Sacred Forest Meadow -> SFM Fairy Grotto',                        { 'entrance': 0x036D, 'content': 0xFF, 'scene': 0x56, 'add_exit': True }),
                        ('SFM Fairy Grotto -> Sacred Forest Meadow',                        {})),
    ('Grotto',          ('LW Beyond Mido -> LW Scrubs Grotto',                              { 'entrance': 0x05B0, 'content': 0xF5, 'scene': 0x5B }),
                        ('LW Scrubs Grotto -> LW Beyond Mido',                              {})),
    ('Grotto',          ('Lost Woods -> LW Near Shortcuts Grotto',                          { 'entrance': 0x003F, 'content': 0x14, 'scene': 0x5B, 'add_exit': True }),
                        ('LW Near Shortcuts Grotto -> Lost Woods',                          {})),
    ('Grotto',          ('Kokiri Forest -> KF Storms Grotto',                               { 'entrance': 0x003F, 'content': 0x2C, 'scene': 0x55, 'add_exit': True }),
                        ('KF Storms Grotto -> Kokiri Forest',                               {})),
    ('Grotto',          ('Zoras Domain -> ZD Storms Grotto',                                { 'entrance': 0x036D, 'content': 0xFF, 'scene': 0x58, 'add_exit': True }),
                        ('ZD Storms Grotto -> Zoras Domain',                                {})),
    ('Grotto',          ('GF Entrances Behind Crates -> GF Storms Grotto',                  { 'entrance': 0x036D, 'content': 0xFF, 'scene': 0x5D, 'add_exit': True }),
                        ('GF Storms Grotto -> GF Entrances Behind Crates',                  {})),
    ('Grotto',          ('GV Fortress Side -> GV Storms Grotto',                            { 'entrance': 0x05BC, 'content': 0xF0, 'scene': 0x5A, 'add_exit': True }),
                        ('GV Storms Grotto -> GV Fortress Side',                            {})),
    ('Grotto',          ('GV Grotto Ledge -> GV Octorok Grotto',                            { 'entrance': 0x05AC, 'content': 0xF2, 'scene': 0x5A }),
                        ('GV Octorok Grotto -> GV Grotto Ledge',                            {})), #TODO (out-of-logic access to Gerudo Valley)
    ('Grotto',          ('LW Beyond Mido -> Deku Theater',                                  { 'entrance': 0x05C4, 'content': 0xF3, 'scene': 0x5B }),
    ...
    ('BlueWarp',        ('Phantom Ganon Blue Warp -> Sacred Forest Meadow',                 { 'index': 0x0608, 'addresses': [0xAC9F96, 0xCA3D66, 0xCA3D5A, 0xCA3D32], 'scene': 0x56, 'add_exit': True })),
    ('BlueWarp',        ('Volvagia Blue Warp -> DMC Central Local',                         { 'index': 0x0564, 'addresses': [0xACA516, 0xCA3DF2, 0xCA3DE6, 0xCA3DBE], 'scene': 0x61, 'add_exit': True })),
    ('BlueWarp',        ('Morpha Blue Warp -> Lake Hylia',                                  { 'index': 0x060C, 'addresses': [0xAC995A, 0xCA3E82, 0xCA3E76, 0xCA3E4A], 'scene': 0x57, 'add_exit': True })),
    ('BlueWarp',        ('Bongo Bongo Blue Warp -> Graveyard Warp Pad Region',              { 'index': 0x0580, 'addresses': [0xACA496, 0xCA3FA2, 0xCA3F96, 0xCA3F6A], 'scene': 0x53, 'add_exit': True })),
    ('BlueWarp',        ('Twinrova Blue Warp -> Desert Colossus',                           { 'index': 0x0610, 'addresses': [0xACA402, 0xCA3F12, 0xCA3F06, 0xCA3EDA], 'scene': 0x5C, 'add_exit': True })),
