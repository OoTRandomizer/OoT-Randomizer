...
entrance_shuffle_table = [
    ...
    ('Dungeon',         ('DMC Exit to Fire Temple -> Fire Temple Lower',                    { 'index': 0x0165 }),
    ...
    ('Interior',        ('DMC Exit to Fairy Fountain -> DMC Great Fairy Fountain',          { 'index': 0x04BE }),
                        ('DMC Great Fairy Fountain -> DMC Near Great Fairy Fountain',       { 'index': 0x0482, 'addresses': [0xBEFD6A] })),
    ...
    ('Grotto',          ('DMC Exit to Hammer Grotto -> DMC Hammer Grotto',                  { 'grotto_id': 0x05, 'entrance': 0x05A4, 'content': 0xF9, 'scene': 0x61 }),
                        ('DMC Hammer Grotto -> DMC Near Hammer Grotto',                     { 'grotto_id': 0x05 })),
    ('Grotto',          ('DMC Exit to Upper Grotto -> DMC Upper Grotto',                    { 'grotto_id': 0x06, 'entrance': 0x003F, 'content': 0x7A, 'scene': 0x61 }),
                        ('DMC Upper Grotto -> DMC Near Upper Grotto',                       { 'grotto_id': 0x06 })),
    ...
    ('Overworld',       ('GC Darunias Chamber -> DMC Near Darunias Chamber',                { 'index': 0x0246 }),
                        ('DMC Exit to Darunias Chamber -> GC Darunias Chamber',             { 'index': 0x01C1 })),
    ('Overworld',       ('Death Mountain Summit -> DMC Near Death Mountain Summit',         { 'index': 0x0147 }),
                        ('DMC Exit to Death Mountain Summit -> Death Mountain Summit',      { 'index': 0x01BD })),
    ...
    ('WarpSong',        ('Bolero of Fire Warp -> DMC Bolero Warp Pad',                      { 'index': 0x04F6, 'addresses': [0xBF023E] })),
...
# - DMC Bolero Warp Pad (child access for the bean and skull)
...
priority_entrance_table = {
    'Bolero': (['DMC Bolero Warp Pad'], ['OwlDrop', 'WarpSong']),
